...
IMAGE_REPOSITORY_SETTINGS = struct(
    ...
    repository_prefix = "ads-open-measurement",
)

# Settings for deploying tests to Google Cloud.
TEST_GOOGLE_CLOUD_SETTINGS = struct(
    spanner_project = "ads-open-measurement",
    spanner_instance = "qa-instance",
    cloud_storage_project = "ads-open-measurement",
    cloud_storage_bucket = "local-measurement-providers",
    bigquery_table = "demo.labelled_events_v2",
)
