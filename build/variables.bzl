...
TEST_K8S_SETTINGS = struct(
    ...
    edp1_result_cert_name = "$(edp1_result_cert_name)",
    edp2_name = "$(edp2_name)",
    edp2_cert_name = "$(edp2_cert_name)",
    edp2_result_cert_name = "$(edp2_result_cert_name)",
    edp3_name = "$(edp3_name)",
    edp3_cert_name = "$(edp3_cert_name)",
    edp3_result_cert_name = "$(edp3_result_cert_name)",
    edp4_name = "$(edp4_name)",
    edp4_cert_name = "$(edp4_cert_name)",
    edp4_result_cert_name = "$(edp4_result_cert_name)",
    edp5_name = "$(edp5_name)",
    edp5_cert_name = "$(edp5_cert_name)",
    edp5_result_cert_name = "$(edp5_result_cert_name)",
    edp6_name = "$(edp6_name)",
    edp6_cert_name = "$(edp6_cert_name)",
    edp6_result_cert_name = "$(edp6_result_cert_name)",
