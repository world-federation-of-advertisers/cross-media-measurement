...
def wfa_measurement_system_repositories():
    ...
    wfa_repo_archive(
        name = "wfa_common_jvm",
        repo = "common-jvm",
        # TODO(world-federation-of-advertisers/common-jvm#85): Switch to version
        # once PR has been merged and released.
        commit = "8efcbafacfaff3ed4e54d791ce72da665787a46d",
        sha256 = "2935d04f50b161c3fc35a403858a324a103eeb6ea8bed7a4da9085738525cd25",
    )
