...
def wfa_measurement_system_repositories():
    ...
    wfa_repo_archive(
        name = "wfa_common_jvm",
        repo = "common-jvm",
        # TODO(world-federation-of-advertisers/common-jvm#81): Switch to version
        # once PR has been merged and released.
        commit = "7a97addda22274ceb0f5fb567b793b8c7cfa8263",
        sha256 = "8b3727ca6a718dbedc49ef12a5de5a88bf055b05554bb2d6fc2c4fd91d33d074",
    )
