...
def wfa_measurement_system_repositories():
    ...
    wfa_repo_archive(
        name = "wfa_common_jvm",
        # DO_NOT_SUBMIT(world-federation-of-advertisers/common-jvm#227): Use version.
        commit = "027415d85994e389160d5ea7ed7d19576be5d21f",
        repo = "common-jvm",
        sha256 = "8c4594c9ba032b826a233f4d4deb676a9faa1366565eff0ab101357ba21cf75b",
    )
