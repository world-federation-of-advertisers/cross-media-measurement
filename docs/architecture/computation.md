...
The `org.wfanet.measurement.computation` package provides core computation utilities for privacy-preserving measurement calculations. It implements histogram-based computations for reach, frequency, and impression metrics with support for differential privacy (DP) and k-anonymity constraints.
