...
Certificates should be able to support both Client and Server TLS. You can use
the OpenSSL CLI to convert between formats as-needed (`openssl x509` for
certificates and `openssl pkcs8` for private keys).

Encryption private keys can be generated using the
