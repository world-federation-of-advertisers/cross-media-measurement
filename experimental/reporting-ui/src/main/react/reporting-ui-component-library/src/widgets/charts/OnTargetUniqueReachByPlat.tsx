...
import { GetTargetUniquReachByPlat } from '../../utils/resolvers';
import { UniqueReach } from '../../models';
import { chartProps } from './ChartProps';

export function OnTargetUniqueReqchByPlat({id, reportId, config}: chartProps) {
    const [ data, setData ] = useState<UniqueReach[] | undefined>();

    useEffect(() => {
        GetTargetUniquReachByPlat(reportId).then(setData);
    }, [reportId]);
