 ...
 *
 * Note that this does not contain any test methods, as most of the functionality of [EdpSimulator]
 * is not overridable by subclasses. Therefore, it only needs to be tested for the base
 * implementation.
 */
