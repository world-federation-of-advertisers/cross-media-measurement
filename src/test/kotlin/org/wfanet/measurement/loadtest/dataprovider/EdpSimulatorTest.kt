...
class EdpSimulatorTest : AbstractEdpSimulatorTest() {
  ...
  @Test
  fun `ensureEventGroup creates EventGroup`() {
    ...
    runBlocking {
      edpSimulator.ensureEventGroup(referenceIdSuffix, MEDIA_TYPES, EVENT_GROUP_METADATA)
    }
  ...
  fun `ignores Requisitions for other MeasurementConsumers`() {
    ...
    runBlocking {
      edpSimulator.ensureEventGroup("", MEDIA_TYPES, EVENT_GROUP_METADATA)
