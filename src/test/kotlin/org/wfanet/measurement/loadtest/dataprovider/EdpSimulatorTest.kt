...
class EdpSimulatorTest {
  ...
  private val requisitionsServiceMock: RequisitionsCoroutineImplBase = mockService {
    onBlocking { listRequisitions(any()) }
      .thenReturn(
        listRequisitionsResponse { requisitions += REQUISITION_ONE })
  ...
  companion object {
    private val MC_SIGNING_KEY = loadSigningKey("${MC_NAME}_cs_cert.der", "${MC_NAME}_cs_private.der")
      ...
      duchies += duchyEntry {
        ...
        value = value {
          ...
          liquidLegionsV2 = liquidLegionsV2 {
            elGamalPublicKey =
              signMessage(CONSENT_SIGNALING_ELGAMAL_PUBLIC_KEY, DUCHY_SIGNING_KEY)
          }
        }
      }
    }
