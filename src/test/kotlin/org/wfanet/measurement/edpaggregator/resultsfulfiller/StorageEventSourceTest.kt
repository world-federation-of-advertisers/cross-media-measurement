...
class StorageEventSourceTest {
  ...
  fun `generateEventBatches uses path-specific EventReaders`(): Unit = runBlocking {
    ...
    val mappings = mapOf(
      Pair("blob-2025-01-01-group-1", "meta-2025-01-01-group-1") to FakeEventReader.withEventCount(5),
      Pair("blob-2025-01-01-group-2", "meta-2025-01-01-group-2") to FakeEventReader.withEventCount(3)
    )
