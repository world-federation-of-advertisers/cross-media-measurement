...
import org.wfanet.measurement.edpaggregator.service.internal.testing.VidLabelingJobServiceTest
...
class SpannerVidLabelingJobServiceTest : VidLabelingJobServiceTest() {
  @get:Rule
  val spannerDatabase =
  ...
  override fun newService(
    ...
    return SpannerVidLabelingJobService(databaseClient, idGenerator = idGenerator)
  }
