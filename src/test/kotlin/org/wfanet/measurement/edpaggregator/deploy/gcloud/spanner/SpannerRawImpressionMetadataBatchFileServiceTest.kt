...
import org.wfanet.measurement.edpaggregator.service.internal.testing.RawImpressionMetadataBatchFileServiceTest
...
class SpannerRawImpressionMetadataBatchFileServiceTest :
  RawImpressionMetadataBatchFileServiceTest() {
  @get:Rule
  val spannerDatabase =
    SpannerEmulatorDatabaseRule(spannerEmulator, Schemata.EDP_AGGREGATOR_CHANGELOG_PATH)

  override fun newBatchService(
    ...
    return SpannerRawImpressionMetadataBatchService(databaseClient, idGenerator = idGenerator)
  }

  override fun newFileService(
    idGenerator: IdGenerator
  ): RawImpressionMetadataBatchFileServiceGrpcKt.RawImpressionMetadataBatchFileServiceCoroutineImplBase {
    val databaseClient: AsyncDatabaseClient = spannerDatabase.databaseClient
    return SpannerRawImpressionMetadataBatchFileService(databaseClient, idGenerator = idGenerator)
  }
