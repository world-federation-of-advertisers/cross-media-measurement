...
class EventTemplateValidatorTest {
  ...
  companion object {
    ...
    private val UK_PILOT_TEMPLATES_PATH =
      Paths.get("uk_pilot_event_templates", "src", "main", "proto", "halo_cmm", "uk", "pilot")
    private val UK_PILOT_TEMPLATES_RUNTIME_PATH by lazy {
      getRuntimePath(UK_PILOT_TEMPLATES_PATH)!!
    }
    ...
    private val TEST_EVENT_DESCRIPTOR_SET_RUNTIME_PATHS by lazy {
      listOf(
        ...
        UK_PILOT_TEMPLATES_RUNTIME_PATH.resolve("common_template_proto-$DESCRIPTOR_SET_SUFFIX"),
        UK_PILOT_TEMPLATES_RUNTIME_PATH.resolve("video_template_proto-$DESCRIPTOR_SET_SUFFIX"),
