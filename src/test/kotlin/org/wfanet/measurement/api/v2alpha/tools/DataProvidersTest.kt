...
class DataProvidersTest {
  ...
  private fun callCli(args: Array<String>): String {
    val capturedOutput = CommandLineTesting.capturingOutput(args, DataProviders::main)
  ...
  fun `dataProviders get calls GetDataProvider with correct params`() {
    val tmpFile = createTempFile("GetDataProvider.textproto")
    val args =
      arrayOf(
        "get",
        "--data-provider-resource=dataProviders/777",
