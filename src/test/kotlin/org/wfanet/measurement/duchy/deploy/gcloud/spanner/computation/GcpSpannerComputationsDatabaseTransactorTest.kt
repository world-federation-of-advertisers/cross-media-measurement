...
class GcpSpannerComputationsDatabaseTransactorTest : UsingSpannerEmulator(COMPUTATIONS_SCHEMA) {
  ...
  fun `insert two computations`() = runBlocking {
    ...
    assertQueryReturns(
      ...
      Struct.newBuilder()
        ...
        .toFakeStage(A)
        .set("UpdateTime")
        .to(TEST_INSTANT.toGcloudTimestamp())
        .set("GlobalComputationId")
        .to(globalId1)
        .set("LockOwner")
        .to(null as String?)
        .set("LockExpirationTime")
        .to(TEST_INSTANT.toGcloudTimestamp())
        .set("ComputationDetails")
        .toProtoBytes(FAKE_COMPUTATION_DETAILS)
        .set("ComputationDetailsJSON")
        .toProtoJson(FAKE_COMPUTATION_DETAILS)
        .build(),
      Struct.newBuilder()
        .set("ComputationId")
        .to(localId2)
    ...
    assertQueryReturns(
      ...
      Struct.newBuilder()
        ...
        .set("Details")
        .toProtoBytes(computationMutations.detailsFor(A))
        .set("DetailsJSON")
        .toProtoJson(computationMutations.detailsFor(A))
        .build(),
      Struct.newBuilder()
        .set("ComputationId")
        .to(localId2)
    ...
    assertQueryReturns(
      ...
      ORDER BY ComputationId DESC
      """.trimIndent(),
      Struct.newBuilder().set("ComputationId").to(localId1).set("N").to(1).build(),
      Struct.newBuilder().set("ComputationId").to(localId2).set("N").to(1).build()
    )
  }
  ...
  fun enqueue() = runBlocking {
    ...
    assertQueryReturns(
      ...
      Struct.newBuilder()
        ...
        .to(0)
        .set("ComputationStage")
        .toFakeStage(token.stage)
        .set("LockOwner")
        .to(null as String?)
        .set("LockExpirationTime")
        .to(TEST_INSTANT.plusSeconds(2).toGcloudTimestamp())
        .set("ComputationDetails")
        .toProtoBytes(FAKE_COMPUTATION_DETAILS)
        .set("ComputationDetailsJSON")
        .toProtoJson(FAKE_COMPUTATION_DETAILS)
      ...
      Struct.newBuilder()
        ...
        .to("PeterSpacemen")
        .set("LockExpirationTime")
        .to(lockExpires.toGcloudTimestamp())
        .set("ComputationDetails")
        .toProtoBytes(FAKE_COMPUTATION_DETAILS)
        .set("ComputationDetailsJSON")
        .toProtoJson(FAKE_COMPUTATION_DETAILS)
  ...
  fun claimTask() = runBlocking {
    ...
    assertQueryReturns(
      ...
      Struct.newBuilder()
        ...
        .to(1)
        .set("BeginTime")
        .to(testClock.last().toGcloudTimestamp())
        .set("EndTime")
        .to(null as Timestamp?)
        .set("Details")
        .toProtoBytes(ComputationStageAttemptDetails.getDefaultInstance())
        .build()
    )
  ...
  private suspend fun assertStageTransitioned(
    ...
    assertQueryReturns(
      ...
      Struct.newBuilder()
        ...
        .toFakeStage(D)
        .set("UpdateTime")
        .to(testClock["update_stage"].toGcloudTimestamp())
        .build()
    )
    ...
    assertQueryReturns(
      ...
      Struct.newBuilder()
        ...
        .toFakeStage(B)
        .set("CreationTime")
        .to(testClock["stage_b_created"].toGcloudTimestamp())
        .set("EndTime")
        .to(testClock["update_stage"].toGcloudTimestamp())
        .set("PreviousStage")
        .to(null as Long?)
        ...
        .set("Details")
        .toProtoBytes(computationMutations.detailsFor(B))
        .build(),
      Struct.newBuilder()
        .set("ComputationId")
        .to(token.localId)
        ...
        .to(null as Long?)
        .set("Details")
        .toProtoBytes(computationMutations.detailsFor(D))
        .build()
    )
  }
  ...
  fun `updateComputationStage and continue working`() = runBlocking {
    ...
    assertQueryReturns(
      ...
      Struct.newBuilder()
        ...
        .set("LockExpirationTime")
        .to(testClock.last().plusSeconds(300).toGcloudTimestamp())
        .build()
    )
    ...
    runBlocking<Unit> {
      ...
      """.trimIndent(),
        Struct.newBuilder()
          ...
          .to(1234L)
          .set("PathToBlob")
          .to("/wrote/something/there")
          .set("DependencyType")
          .toProtoEnum(ComputationBlobDependency.OUTPUT)
          .set("UpdateTime")
          .to(testClock.get("write-blob-ref").toGcloudTimestamp())
          .build(),
        Struct.newBuilder()
          .set("ComputationId")
          .to(token.localId)
          ...
          .to(5678L)
          .set("PathToBlob")
          .to("/path/to/input/blob")
          .set("DependencyType")
          .toProtoEnum(ComputationBlobDependency.INPUT)
          .set("UpdateTime")
          .to(testClock.get("write-blob-ref").toGcloudTimestamp())
          .build()
      )
  ...
  fun `update computation details`() = runBlocking {
    ...
    assertQueryReturns(
      ...
      Struct.newBuilder()
        ...
        .to(lockExpires.toGcloudTimestamp())
        .set("ComputationDetails")
        .toProtoBytes(newComputationDetails)
        .set("ComputationDetailsJSON")
        .toProtoJson(newComputationDetails)
        .build()
    )
  }
  ...
  fun `write requisition blob path`() = runBlocking {
    ...
    assertQueryReturns(
      databaseClient,
      """
      SELECT r.ComputationId, r.RequisitionId, r.ExternalDataProviderId, r.ExternalRequisitionId, r.PathToBlob,
             c.UpdateTime
      ...
      Struct.newBuilder()
        ...
        .to("foo/A")
        .set("UpdateTime")
        .to(lastUpdated.toGcloudTimestamp())
        .build(),
      Struct.newBuilder()
        .set("ComputationId")
        .to(token.localId)
    ...
    database.writeRequisitionBlobPath(
      token,
      ExternalRequisitionKey("B", "22222"),
      "this is a new path"
    )
  ...
  fun `end successful computation`() = runBlocking {
    ...
    assertQueryReturns(
      ...
      Struct.newBuilder()
        ...
        .to(null as Timestamp?)
        .set("ComputationDetails")
        .toProtoBytes(expectedDetails)
        .set("ComputationDetailsJSON")
        .toProtoJson(expectedDetails)
        .build()
    )
    ...
    assertQueryReturns(
      ...
      Struct.newBuilder()
        ...
        .to(1)
        .set("BeginTime")
        .to(testClock["start"].toGcloudTimestamp())
        .set("EndTime")
        .to(testClock.last().toGcloudTimestamp())
        .set("Details")
        .toProtoBytes(
