...
class DataWatcherTest() {
  ...
  fun `records processing_duration metric for control plane sink`() {
    runBlocking {
      ...
      assertThat(point.attributes.get(AttributeKey.stringKey("edpa.data_watcher.config_identifier")))
  ...
  fun `records queue_writes counter metric`() {
    runBlocking {
      ...
      assertThat(point.attributes.get(AttributeKey.stringKey("edpa.data_watcher.queue"))).isEqualTo(topicId)
      assertThat(point.attributes.get(AttributeKey.stringKey("edpa.data_watcher.config_identifier")))
        .isEqualTo(configIdentifier)
    }
  }
