...
class DataWatcherFunctionTracingTest {
  ...
  fun tearDownTelemetry() {
    ...
    openTelemetry.close()
    DataWatcherFunction.clearPathReceiverForTest()
  }
  ...
  fun `propagates traceparent from CloudEvent to DataWatcher work`() {
    ...
    DataWatcherFunction.setPathReceiverForTest { _ ->
    ...
    DataWatcherFunction().accept(cloudEvent)
  ...
  companion object {
    ...
    private const val EVENT_SOURCE =
