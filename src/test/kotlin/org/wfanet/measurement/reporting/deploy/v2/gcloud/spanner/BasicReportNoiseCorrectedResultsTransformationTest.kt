  ...
  fun `buildResultGroups creates result groups correctly`() {
    ...
    val reportResult = reportResult {
      ...
      reportingSetResults += ReportResultKt.reportingSetResult {
        ...
        externalImpressionQualificationFilterId = IMPRESSION_QUALIFICATION_FILTER_1.externalImpressionQualificationFilterId
    ...
    val compositeReportingSetIdBySetExpression =
      mapOf(
        buildUnionSetExpression(listOf(PRIMITIVE_REPORTING_SET_1_ID, PRIMITIVE_REPORTING_SET_2_ID)) to
          COMPOSITE_REPORTING_SET_1_2_ID,
      )
            ...
            metricSet = ResultGroupKt.metricSet {
              ...
              components += ResultGroupKt.MetricSetKt.dataProviderComponentMetricSetMapEntry {
                ...
                value = ResultGroupKt.MetricSetKt.componentMetricSet {
                  cumulative = ResultGroupKt.MetricSetKt.basicMetricSet { impressions = 100 }
              ...
              components += ResultGroupKt.MetricSetKt.dataProviderComponentMetricSetMapEntry {
                ...
                value = ResultGroupKt.MetricSetKt.componentMetricSet {
                  cumulative = ResultGroupKt.MetricSetKt.basicMetricSet { impressions = 200 }
                  cumulativeUnique = ResultGroupKt.MetricSetKt.uniqueMetricSet {
                    reach = 15 // 25 - 10
                  }
                }
          ...
          results += ResultGroupKt.result {
            ...
            metricSet = ResultGroupKt.metricSet {
              ...
              components += ResultGroupKt.MetricSetKt.dataProviderComponentMetricSetMapEntry {
                key = DATA_PROVIDER_1_ID
                value = ResultGroupKt.MetricSetKt.componentMetricSet {
                  nonCumulative = ResultGroupKt.MetricSetKt.basicMetricSet { impressions = 100 }
              ...
              components += ResultGroupKt.MetricSetKt.dataProviderComponentMetricSetMapEntry {
                key = DATA_PROVIDER_2_ID
                value = ResultGroupKt.MetricSetKt.componentMetricSet {
                  nonCumulative = ResultGroupKt.MetricSetKt.basicMetricSet { impressions = 200 }
                  nonCumulativeUnique = ResultGroupKt.MetricSetKt.uniqueMetricSet {
                    reach = 15 // 25 - 10
                  }
                }
  ...
  fun `buildResultGroups creates result groups correctly when reporting unit with 3 components`() {
    ...
    val compositeReportingSetIdBySetExpression =
      mapOf(
        buildUnionSetExpression(listOf(PRIMITIVE_REPORTING_SET_1_ID, PRIMITIVE_REPORTING_SET_2_ID)) to
          COMPOSITE_REPORTING_SET_1_2_ID,
        buildUnionSetExpression(listOf(PRIMITIVE_REPORTING_SET_1_ID, PRIMITIVE_REPORTING_SET_3_ID)) to
          COMPOSITE_REPORTING_SET_1_3_ID,
        buildUnionSetExpression(listOf(PRIMITIVE_REPORTING_SET_2_ID, PRIMITIVE_REPORTING_SET_3_ID)) to
          COMPOSITE_REPORTING_SET_2_3_ID,
        buildUnionSetExpression(listOf(PRIMITIVE_REPORTING_SET_1_ID, PRIMITIVE_REPORTING_SET_2_ID, PRIMITIVE_REPORTING_SET_3_ID)) to
          COMPOSITE_REPORTING_SET_1_2_3_ID,
      )
          ...
          results += ResultGroupKt.result {
            ...
            metricSet = ResultGroupKt.metricSet {
              ...
              components += ResultGroupKt.MetricSetKt.dataProviderComponentMetricSetMapEntry {
                ...
                value = ResultGroupKt.MetricSetKt.componentMetricSet {
                  nonCumulative = ResultGroupKt.MetricSetKt.basicMetricSet { impressions = 300 }
                  nonCumulativeUnique = ResultGroupKt.MetricSetKt.uniqueMetricSet {
                    reach = 30 // 55 - 25
                  }
                }
          ...
          results += ResultGroupKt.result {
            ...
            metricSet = ResultGroupKt.metricSet {
              ...
              components += ResultGroupKt.MetricSetKt.dataProviderComponentMetricSetMapEntry {
                key = DATA_PROVIDER_2_ID
                value = ResultGroupKt.MetricSetKt.componentMetricSet {
                  cumulative = ResultGroupKt.MetricSetKt.basicMetricSet { impressions = 300 }
                }
              }
            }
          }
          results += ResultGroupKt.result {
            ...
            metricSet = ResultGroupKt.metricSet {
              ...
              components += ResultGroupKt.MetricSetKt.dataProviderComponentMetricSetMapEntry {
                key = DATA_PROVIDER_2_ID
                value = ResultGroupKt.MetricSetKt.componentMetricSet {
                  cumulative = ResultGroupKt.MetricSetKt.basicMetricSet { impressions = 400 }
                }
              }
            }
          }
  ...
  fun `buildResultGroups creates different results for different windows`() {
    ...
    val reportResult = reportResult {
      ...
      reportingSetResults += ReportResultKt.reportingSetResult {
        ...
        populationSize = 100
        reportingWindowResults += ReportResultKt.ReportingSetResultKt.reportingWindowResult {
          windowStartDate = REPORTING_INTERVAL.reportEnd.copy {
            day = REPORTING_INTERVAL.reportStart.day
            month = REPORTING_INTERVAL.reportStart.month
            year = REPORTING_INTERVAL.reportStart.year
          }
          windowEndDate = REPORTING_INTERVAL.reportEnd.copy {
        ...
        resultGroup {
          ...
          results += ResultGroupKt.result {
            metadata = ResultGroupKt.metricMetadata {
              ...
              nonCumulativeMetricStartTime = REPORTING_INTERVAL.reportStart
                .copy {
                  day = REPORTING_INTERVAL.reportStart.day + 7
                }
                .toTimestamp()
