...
class BasicReportsReportsJobTest {
  ...
  @Test
  fun `execute paginates through all REPORT_CREATED basic reports across multiple pages`(): Unit = runBlocking {
  ...
  @Test
  fun `execute does not fetch second page when first response has no next page token`(): Unit = runBlocking {
