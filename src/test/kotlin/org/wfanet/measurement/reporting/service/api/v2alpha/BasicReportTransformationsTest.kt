      ...
      .containsEntry(
        ...
        buildList {
          add(
            MetricCalculationSpecKt.details {
              filter =
                "((has(banner_ad) && banner_ad.viewable == true) || (has(video_ad) && video_ad.viewed_fraction == 1.0)) && (person.age_group == 1 && person.gender == 1)"
              metricFrequencySpec =
  ...
  fun `different values in dimensionSpec filter can be processed and sorted`() {
    ...
    assertThat(reportingSetMetricCalculationSpecDetailsMap[PRIMITIVE_REPORTING_SET_1])
      .containsExactly(
        ...
        MetricCalculationSpecKt.details {
          filter =
            "((has(banner_ad) && banner_ad.viewable == true) || (has(video_ad) && video_ad.viewed_fraction == 1.0)) && (banner_ad.viewable == true && person.age_group == 1 && video_ad.viewed_fraction == 0.5)"
          metricSpecs += metricSpec { reach = MetricSpecKt.reachParams {} }
        },
      )
  }
      ...
      .containsEntry(
        ...
        buildList {
          ...
          add(
            MetricCalculationSpecKt.details {
              filter =
                "(has(video_ad) && video_ad.viewed_fraction == 1.0) && (person.age_group == 1 && person.gender == 1)"
              metricSpecs += metricSpec { reach = MetricSpecKt.reachParams {} }
            }
          )
          add(
            MetricCalculationSpecKt.details {
              filter =
                "(has(banner_ad) && banner_ad.viewable == true) && (person.age_group == 1 && person.gender == 1)"
              metricSpecs += metricSpec { reach = MetricSpecKt.reachParams {} }
            }
          )
        },
      ...
      .containsEntry(
        ...
        buildList {
          ...
          add(
            MetricCalculationSpecKt.details {
              filter =
                "((has(banner_ad) && banner_ad.viewable == true) || (has(video_ad) && video_ad.viewed_fraction == 0.5)) && (person.age_group == 1 && person.gender == 1)"
              metricSpecs += metricSpec { reach = MetricSpecKt.reachParams {} }
            }
          )
        },
  ...
  fun `resultGroupSpec with IQF with no filters transforms into correct map`() {
    ...
    assertThat(reportingSetMetricCalculationSpecDetailsMap[PRIMITIVE_REPORTING_SET_1])
      .containsExactly(
        ...
        MetricCalculationSpecKt.details {
          filter =
            "((has(banner_ad)) || (has(video_ad))) && (person.age_group == 1 && person.gender == 1)"
          metricSpecs += metricSpec { reach = MetricSpecKt.reachParams {} }
        },
      )
  }
