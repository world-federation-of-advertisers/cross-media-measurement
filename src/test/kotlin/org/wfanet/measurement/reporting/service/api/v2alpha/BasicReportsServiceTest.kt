...
class BasicReportsServiceTest {
  ...
  fun `createBasicReport doesn't require hours and time_offset when default exists`(): Unit =
    runBlocking {
      ...
      val basicReport = BASIC_REPORT.copy {
        this.campaignGroup = campaignGroupKey.toName()
        reportingInterval = BASIC_REPORT.reportingInterval.copy {
  ...
  @Test
  fun `createBasicReport hours overwrites default`(): Unit =
    runBlocking {
      service =
        BasicReportsService(
          internalBasicReportsService,
  ...
  @Test
  fun `createBasicReport utc_offset overwrites default`(): Unit =
    runBlocking {
      service =
        BasicReportsService(
          internalBasicReportsService,
      ...
      val request = createBasicReportRequest {
        ...
        basicReport =
          BASIC_REPORT.copy {
            ...
            reportingInterval =
              this.reportingInterval.copy {
                reportStart = this.reportStart.copy {
                  timeZone = timeZone {
                    id = "America/Atlantis"
                  }
                }
      ...
      assertThat(exception.errorInfo)
        .isEqualTo(
          errorInfo {
            ...
            reason = Errors.Reason.INVALID_FIELD_VALUE.name
            metadata[Errors.Metadata.FIELD_NAME.key] =
              "basic_report.reporting_interval.report_start.time_zone.id"
          }
        )
    }
      ...
      assertThat(exception.errorInfo)
        .isEqualTo(
          errorInfo {
            ...
            reason = Errors.Reason.INVALID_FIELD_VALUE.name
            metadata[Errors.Metadata.FIELD_NAME.key] =
              "basic_report.reporting_interval.report_start.utc_offset"
          }
        )
    }
