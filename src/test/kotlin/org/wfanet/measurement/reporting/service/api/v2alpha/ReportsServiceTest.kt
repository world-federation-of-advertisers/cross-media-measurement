...
import org.wfanet.measurement.internal.reporting.v2.ReportKt.metricCalculationSpec
import org.wfanet.measurement.internal.reporting.v2.ReportKt.reportingMetricCalculationSpec
...
private val INTERNAL_PENDING_REACH_REPORT = internalReport {
  ...
  reportingMetricEntries.putAll(
    mapOf(
      PRIMITIVE_REPORTING_SETS.first().externalId to
              ...
              InternalReportKt.createMetricRequest {
                ...
                details =
                  InternalReportKt.CreateMetricRequestKt.details {
                    externalReportingSetId = PRIMITIVE_REPORTING_SETS.first().externalId
        ...
        reportingMetricEntries.putAll(
          mapOf(
            targetReportingSet.externalId to
              reportingMetricCalculationSpec {
                metricCalculationSpecs += metricCalculationSpec {
                  this.createMetricRequests += initialReportingCreateMetricRequests
                  details =
                    InternalReportKt.MetricCalculationSpecKt.details {
                ...
                reportingMetricCalculationSpec {
                  metricCalculationSpecs += metricCalculationSpec {
                    this.createMetricRequests +=
                      initialReportingCreateMetricRequests.mapIndexed { index, createMetricRequest
                        ->
                        createMetricRequest.copy { requestId = index.toString() }
                      }
                    details =
                      InternalReportKt.MetricCalculationSpecKt.details {
                        this.displayName = displayName
              ...
              metricCalculationSpecs += metricCalculationSpec {
                ...
                details =
                  InternalReportKt.MetricCalculationSpecKt.details {
                    this.displayName = displayName
                    metricSpecs += INTERNAL_REACH_METRIC_SPEC
                    this.groupings += internalGroupings
                    cumulative = false
                  }
              }
            }
              ...
              reportingMetricCalculationSpec {
                metricCalculationSpecs += metricCalculationSpec {
                  ...
                  details =
                    InternalReportKt.MetricCalculationSpecKt.details {
                      this.displayName = displayName
                      this.metricSpecs += internalMetricSpecs
                      cumulative = false
                    }
                }
              }
  ...
  fun `createReport returns report with 2 metrics generated when there are 2 reporting sets`() =
    runBlocking {
      ...
      val internalRequestingReport = internalReport {
        ...
        timeIntervals = internalTimeIntervals { timeIntervals += internalTimeInterval }
        reportingMetricEntries.putAll(
          targetReportingSets.associate { reportingSet ->
            reportingSet.externalId to
              reportingMetricCalculationSpec {
                metricCalculationSpecs += metricCalculationSpec {
                  this.createMetricRequests +=
                    InternalReportKt.createMetricRequest {
                      details =
                        InternalReportKt.CreateMetricRequestKt.details {
                          externalReportingSetId = reportingSet.externalId
                          this.timeInterval = internalTimeInterval
                          this.metricSpec = INTERNAL_REACH_METRIC_SPEC
                        }
                    }
                  details =
                    InternalReportKt.MetricCalculationSpecKt.details {
      ...
      val internalPendingReport =
        internalRequestingReport.copy {
          ...
          reportingMetricEntries.clear()
          reportingMetricEntries.putAll(
            targetReportingSets.withIndex().associate { (requestId, reportingSet) ->
              reportingSet.externalId to
                reportingMetricCalculationSpec {
                  metricCalculationSpecs += metricCalculationSpec {
                    this.createMetricRequests +=
      ...
      val requestingMetrics: List<Metric> =
        targetReportingSets.map { reportingSet ->
          metric {
            ...
            this.timeInterval = timeInterval
            this.metricSpec = REACH_METRIC_SPEC
          }
        }
