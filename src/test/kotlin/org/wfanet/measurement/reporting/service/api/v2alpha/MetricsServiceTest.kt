  ...
  INTERNAL_PENDING_SINGLE_PUBLISHER_REACH_FREQUENCY_MEASUREMENT.copy {
    ...
    details =
      InternalMeasurementKt.details {
        result =
          InternalMeasurementKt.result {
            reach = InternalMeasurementKt.ResultKt.reach { value = REACH_FREQUENCY_REACH_VALUE }
            frequency =
        ...
        .containsExactly(
          batchSetMeasurementResultsRequest {
            ...
            measurementResults += measurementResult {
              ...
              this.result =
                INTERNAL_SUCCEEDED_SINGLE_PUBLISHER_REACH_FREQUENCY_MEASUREMENT.details.result
              computationConfigs +=
