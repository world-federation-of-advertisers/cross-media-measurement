...
class MetricsServiceTest {
  ...
  @Test
  fun `getMetric throws IllegalStateException when the succeeded metric contains measurement with two reach results`():
    Unit = runBlocking {
    whenever(internalMetricsMock.batchGetMetrics(any()))
      .thenReturn(
        internalBatchGetMetricsResponse {
  ...
  @Test
  fun `getMetric throws IllegalStateException when the succeeded metric contains no measurement`():
    Unit = runBlocking {
    whenever(internalMetricsMock.batchGetMetrics(any()))
      .thenReturn(
        internalBatchGetMetricsResponse {
  ...
  @Test
  fun `getMetric throws IllegalStateException for reach metric when custom direct methodology has frequency`():
    Unit = runBlocking {
    whenever(internalMetricsMock.batchGetMetrics(any()))
      .thenReturn(
        internalBatchGetMetricsResponse {
  ...
  @Test
  fun `getMetric throws IllegalStateException when the succeeded metric contains measurement with two reach frequency results`():
    Unit = runBlocking {
    whenever(internalMetricsMock.batchGetMetrics(any()))
      .thenReturn(
        internalBatchGetMetricsResponse {
  ...
  @Test
  fun `getMetric throws IllegalStateException for reach frueqency metric when custom direct methodology has scalar`():
    Unit = runBlocking {
    whenever(internalMetricsMock.batchGetMetrics(any()))
      .thenReturn(
        internalBatchGetMetricsResponse {
  ...
  @Test
  fun `getMetric throws IllegalStateException for impression metric when custom direct methodology has frequency`():
    Unit = runBlocking {
    whenever(internalMetricsMock.batchGetMetrics(any()))
      .thenReturn(
        internalBatchGetMetricsResponse {
  ...
  @Test
  fun `getMetric throws throws IllegalStateException for watch duration metric when custom direct methodology has frequency`():
    Unit = runBlocking {
    whenever(internalMetricsMock.batchGetMetrics(any()))
      .thenReturn(
        internalBatchGetMetricsResponse {
