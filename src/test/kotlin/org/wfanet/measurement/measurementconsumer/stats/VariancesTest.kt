...
class VariancesTest {
  ...
  @Test
  fun `computeDeterministicVariance returns for reach-frequency when maximum freqeuncy is 1`() {
  ...
  @Test
  fun `computeLiquidLegionsSketchVariance returns for reach-frequency when maximum freqeuncy is 1`() {
    val decayRate = 1e-3
    val sketchSize = 1e5
    val liquidLegionsSketchParams = LiquidLegionsSketchParams(decayRate, sketchSize)
  ...
  @Test
  fun `computeLiquidLegionsV2Variance returns for reach-frequency when maximum freqeuncy is 1`() {
    val decayRate = 1e-3
    val sketchSize = 1e5
    val liquidLegionsSketchParams = LiquidLegionsSketchParams(decayRate, sketchSize)
