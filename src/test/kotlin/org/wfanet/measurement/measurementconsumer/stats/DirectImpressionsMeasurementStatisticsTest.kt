...
class DirectImpressionsMeasurementStatisticsTest {
  private lateinit var directImpressionsMeasurementStatistics:
    DirectImpressionsMeasurementStatistics

  @Before
  fun initService() {
    directImpressionsMeasurementStatistics = DirectImpressionsMeasurementStatistics()
  }
  ...
  fun `variance returns a value when impressions is 0`() {
    ...
    val impressionsMeasurementParams =
      ImpressionsMeasurementParams(vidSamplingIntervalWidth, dpParams, maximumFrequency)

    val variance =
      directImpressionsMeasurementStatistics.variance(impressions, impressionsMeasurementParams)
    val expect = 2.5e-7
  ...
  fun `variance throws IllegalArgumentException when impressions is negative`() {
    ...
    val dpParams = DpParams(1.0, 1.0)
    val impressionsMeasurementParams =
      ImpressionsMeasurementParams(vidSamplingIntervalWidth, dpParams, 1)
