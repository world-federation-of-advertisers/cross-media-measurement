...
import org.wfanet.measurement.kingdom.service.internal.testing.EventGroupActivitiesServiceTest
import org.wfanet.measurement.kingdom.service.internal.testing.Population

@RunWith(JUnit4::class)
class SpannerEventGroupActivitiesServiceTest :
  EventGroupActivitiesServiceTest<SpannerEventGroupActivitiesService>() {
  ...
  override fun newServices(idGenerator: IdGenerator): Services<SpannerEventGroupActivitiesService> {
    val spannerServices =
    ...
    return Services(
      ...
      spannerServices.eventGroupActivitiesService as SpannerEventGroupActivitiesService,
      spannerServices.eventGroupsService,
