...
private const val CERTIFICATE_ID = 3L
...
>>>>>>> f73cb724 (preparing)
  ...
  fun populateDatabase() = runBlocking {
    insertMeasurementConsumerCertificate(CERTIFICATE_ID)
  ...
  fun coverage() {
    val serviceDescriptors =
      listOf(MeasurementConsumersGrpcKt.serviceDescriptor, CertificatesGrpcKt.serviceDescriptor)
