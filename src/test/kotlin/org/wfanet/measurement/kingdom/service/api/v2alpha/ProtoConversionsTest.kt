...
private val V2ALPHA_EDP_IMPORT_STEP = v2AlphaStep {
  ...
  inputLabels["bar"] = "edp-import-bar"
...
class ProtoConversionsTest {
  ...
  @Test
  fun `ExchangeWorkflow toInternal does not make copyFromPreviousExchangeStep its own prerequisite`() {
    val v2AlphaWorkflow = v2AlphaWorkflow {
      steps +=
        listOf(
          V2ALPHA_EDP_INPUT_STEP,
