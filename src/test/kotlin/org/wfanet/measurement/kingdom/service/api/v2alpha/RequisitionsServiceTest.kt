...
class RequisitionsServiceTest {
  ...
  @Test
  fun `refuseRequisition throws UNAUTHENTICATED when MeasurementConsumer principal is not found`() {
    val exception =
      assertFailsWith<StatusRuntimeException> {
  ...
  @Test
  fun `refuseRequisition with refusal returns the updated requisition`() {
