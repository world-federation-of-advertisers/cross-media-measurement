...
class PrivacyBudgetLedgerTest {
  ...
  fun `Charge works when charge list is empty`() {
	...
	fun `Charge multiple buckets`() {
		...
		ledger.chargePrivacyBucketGroups(listOf(bucket1),
																		 listOf(PrivacyCharge(0.5f, 0.001f)))

		ledger.chargePrivacyBucketGroups(listOf(bucket2),
																		 listOf(PrivacyCharge(0.5f, 0.001f)))
	...
	fun `Charge list of values`() {
		...
		val chargeList = listOf(PrivacyCharge(0.5f, 0.001f),
														PrivacyCharge(0.3f, 0.001f),
														PrivacyCharge(0.2f, 0.001f))
