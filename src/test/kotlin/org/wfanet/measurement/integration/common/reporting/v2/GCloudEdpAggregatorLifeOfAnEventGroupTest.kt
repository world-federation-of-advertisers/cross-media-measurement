...
/** Implementation of [InProcessEdpAggregatorLifeOfAnEventGroupTest] for GCloud backends. */
class GCloudEdpAggregatorLifeOfAnEventGroupTest :
  InProcessEdpAggregatorLifeOfAnEventGroupTest(
