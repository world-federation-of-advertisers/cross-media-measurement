...
/** Implementation of [InProcessEdpAggregatorDirectOnlyReportTest] for GCloud backends. */
class GCloudEdpAggregatorDirectOnlyReportTest :
  InProcessEdpAggregatorDirectOnlyReportTest(
