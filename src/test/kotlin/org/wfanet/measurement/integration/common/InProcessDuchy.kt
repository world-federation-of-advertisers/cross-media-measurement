...
import org.wfanet.measurement.system.v1alpha.ComputationParticipantsGrpcKt.ComputationParticipantsCoroutineStub as SystemCComputationParticipantsCoroutineStub
...
class InProcessDuchy(
  ...
  private val systemComputationParticipantsStub by lazy {
    SystemCComputationParticipantsCoroutineStub(kingdomChannel).withDuchyId(duchyId)
  }
