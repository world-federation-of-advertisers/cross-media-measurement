...
import org.wfanet.measurement.integration.common.TRUSTEE_PROTOCOL_CONFIG_CONFIG_THRESHOLDS_NO_NOISE_HIGH
 ...
 * database. Uses no-noise TrusTee protocol config with high small-cell suppression thresholds that cause some
  ...
  companion object {
    ...
    fun initConfig() {
      InProcessCmmsComponents.initConfig(
        trusTeeProtocolConfigConfig = TRUSTEE_PROTOCOL_CONFIG_CONFIG_THRESHOLDS_NO_NOISE_HIGH,
