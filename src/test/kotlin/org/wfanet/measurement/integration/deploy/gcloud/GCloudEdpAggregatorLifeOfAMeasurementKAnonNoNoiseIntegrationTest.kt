...
import org.wfanet.measurement.integration.common.TRUSTEE_PROTOCOL_CONFIG_CONFIG_K_ANON_NO_NOISE

/**
 * Implementation of [InProcessEdpAggregatorLifeOfAMeasurementIntegrationTest] for GCloud backends
 * with Spanner database. Uses TrusTee protocol config with k-anonymity params and no noise.
 */
class GCloudEdpAggregatorLifeOfAMeasurementKAnonNoNoiseIntegrationTest :
  ...
  companion object {
    ...
    fun initConfig() {
      InProcessCmmsComponents.initConfig(
        trusTeeProtocolConfigConfig = TRUSTEE_PROTOCOL_CONFIG_CONFIG_K_ANON_NO_NOISE,
