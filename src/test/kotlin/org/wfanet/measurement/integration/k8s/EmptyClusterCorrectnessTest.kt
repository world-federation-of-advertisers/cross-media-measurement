  ...
  private data class ResourceInfo(
    ...
    companion object {
      fun from(resources: Iterable<Resources.Resource>): ResourceInfo {
        ...
        val eventDataProviders = mutableMapOf<String, Resources.Resource>()
        ...
        for (resource in resources) {
          ...
          when (resource.resourceCase) {
            ...
            Resources.Resource.ResourceCase.DATA_PROVIDER -> {
              ...
              require(eventDataProviders.putIfAbsent(displayName, resource) == null) {
        ...
        return ResourceInfo(
          ...
          dataProviders = eventDataProviders,
