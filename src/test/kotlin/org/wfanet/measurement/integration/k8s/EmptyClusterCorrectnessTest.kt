...
class EmptyClusterCorrectnessTest : AbstractCorrectnessTest(measurementSystem) {
  ...
  companion object {
    ...
    private val WORKSPACE_PATH = Paths.get("wfa_measurement_system")
    ...
    private val SECRET_FILES_PATH = Paths.get("src", "main", "k8s", "testing", "secretfiles")
    ...
    private fun getRuntimePath(workspaceRelativePath: Path): Path {
      return checkNotNull(
