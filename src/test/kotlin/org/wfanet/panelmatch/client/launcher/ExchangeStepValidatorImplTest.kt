...
import org.wfanet.panelmatch.common.Fingerprinters.farmHashFingerprint64
...
private val EXCHANGE_STEP =
  ApiClient.ClaimedExchangeStep(
    ...
    workflowFingerprint = farmHashFingerprint64(EXCHANGE_WORKFLOW.toByteString()),
  )
...
class ExchangeStepValidatorImplTest {
  ...
  fun differentExchangeWorkflow() {
    ...
    val wrongExchangeStep =
      EXCHANGE_STEP.copy(
        workflowFingerprint = farmHashFingerprint64(wrongExchangeWorkflow.toByteString())
      )
