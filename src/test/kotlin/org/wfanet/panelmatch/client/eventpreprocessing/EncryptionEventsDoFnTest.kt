...
private object FakeGetIdentifierHashPepper : SerializableFunction<Void?, ByteString> {
  override fun apply(void: Void?): ByteString {
    return ByteString.copyFromUtf8("fakeidentifierhashpepper")
  }
}

private object FakeGetHkdfPepper : SerializableFunction<Void?, ByteString> {
  override fun apply(void: Void?): ByteString {
    return ByteString.copyFromUtf8("fakehkdfpepper")
  }
}
