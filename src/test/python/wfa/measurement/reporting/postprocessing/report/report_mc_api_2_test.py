    ...
    metric_reports={
        "ami": MetricReport(
            ...
            whole_campaign_measurements=build_measurement_set(
                reach={
                    frozenset({EDP_ONE}): Measurement(11978894, 10000, "measurement_009"),
                    frozenset({EDP_TWO}): Measurement(6000000, 0, "measurement_010"),
                    frozenset({EDP_THREE}): Measurement(1000000, 0, "measurement_011"),
                ...
                impression={
                    frozenset({EDP_ONE}): Measurement(22870892, 10000, "measurement_034"),
                    frozenset({EDP_TWO}): Measurement(11216125, 0, "measurement_035"),
                    frozenset({EDP_THREE}): Measurement(1844136, 0, "measurement_036"),
                    frozenset({EDP_ONE, EDP_TWO}):
            ...
            weekly_non_cumulative_measurements={
                frozenset({EDP_ONE}): [
                    MeasurementSet(
                        reach = Measurement(10008130, 10000, "measurement_039"),
                        k_reach = {
                            1: Measurement(5165486, 10000, "measurement_040"),
                            2: Measurement(2582743, 10000, "measurement_041"),
                            3: Measurement(1291372, 10000, "measurement_042"),
                            4: Measurement(645686, 10000, "measurement_043"),
                            5: Measurement(322843, 10000, "measurement_044"),
                        },
                        impression = Measurement(18379493, 10000, "measurement_045"),
                    ),
                    MeasurementSet(
                        reach = Measurement(2452001, 10000, "measurement_046"),
                        k_reach = {
                            1: Measurement(1265549, 10000, "measurement_047"),
                            2: Measurement(632775, 10000, "measurement_048"),
                            3: Measurement(316388, 10000, "measurement_049"),
                            4: Measurement(158194, 10000, "measurement_050"),
                            5: Measurement(79095, 10000, "measurement_051"),
                        },
                        impression = Measurement(4471035, 10000, "measurement_052"),
                    )
                ],
                frozenset({EDP_TWO}): [
                    MeasurementSet(
                        ...
                        impression = Measurement(9193546, 0, "measurement_059"),
                    ),
                    MeasurementSet(
                        ...
                        impression = Measurement(2022579, 0, "measurement_066"),
                    )
                ],
                frozenset({EDP_THREE}): [
                    MeasurementSet(
                        ...
                        impression = Measurement(1470967, 0, "measurement_073"),
                    ),
                    MeasurementSet(
                        ...
                        impression = Measurement(373169, 0, "measurement_080"),
                    )
                ],
                frozenset({EDP_ONE, EDP_TWO, EDP_THREE}): [
                    MeasurementSet(
                        reach = Measurement(15829304, 10000, "measurement_081"),
                        k_reach = {
                            1: Measurement(8169963, 10000, "measurement_082"),
                            2: Measurement(4084982, 10000, "measurement_083"),
                            3: Measurement(2042491, 10000, "measurement_084"),
                            4: Measurement(1021246, 10000, "measurement_085"),
                            5: Measurement(510622, 10000, "measurement_086"),
                        },
                        impression = Measurement(29046331, 10000, "measurement_087"),
                    ),
                    MeasurementSet(
                        reach = Measurement(3761510, 10000, "measurement_088"),
                        k_reach = {
                            1: Measurement(1941425, 10000, "measurement_089"),
                            2: Measurement(970713, 10000, "measurement_090"),
                            3: Measurement(485357, 10000, "measurement_091"),
                            4: Measurement(242679, 10000, "measurement_092"),
                            5: Measurement(121336, 10000, "measurement_093"),
                        },
                        impression = Measurement(6904573, 10000, "measurement_094"),
                    )
                ],
            },
        ),
        "mrc": MetricReport(
            ...
            whole_campaign_measurements=build_measurement_set(
                reach={
                    frozenset({EDP_ONE}): Measurement(11382243, 10000, "measurement_103"),
                    frozenset({EDP_TWO}): Measurement(5700000, 0, "measurement_104"),
                    frozenset({EDP_THREE}): Measurement(950000, 0, "measurement_105"),
                    frozenset({EDP_ONE, EDP_TWO}):
                ...
                impression={
                    frozenset({EDP_ONE}): Measurement(21696322, 10000, "measurement_127"),
                    frozenset({EDP_TWO}): Measurement(10645760, 0, "measurement_128"),
                    frozenset({EDP_THREE}): Measurement(1751669, 0, "measurement_129"),
                    frozenset({EDP_ONE, EDP_TWO}):
            ...
            weekly_non_cumulative_measurements={
                frozenset({EDP_ONE}): [
                    MeasurementSet(
                        reach = Measurement(9503446, 10000, "measurement_131"),
                        k_reach = {
                            1: Measurement(4905004, 10000, "measurement_132"),
                            2: Measurement(2452502, 10000, "measurement_133"),
                            3: Measurement(1226251, 10000, "measurement_134"),
                            4: Measurement(613126, 10000, "measurement_135"),
                            5: Measurement(306563, 10000, "measurement_136"),
                        },
                        impression = Measurement(17473517, 10000, "measurement_137"),
                    ),
                    MeasurementSet(
                        reach = Measurement(2289252, 10000, "measurement_138"),
                        k_reach = {
                            1: Measurement(1181549, 10000, "measurement_139"),
                            2: Measurement(590775, 10000, "measurement_140"),
                            3: Measurement(295388, 10000, "measurement_141"),
                            4: Measurement(147694, 10000, "measurement_142"),
                            5: Measurement(73846, 10000, "measurement_143"),
                        },
                        impression = Measurement(4236753, 10000, "measurement_144"),
                    )
                ],
                frozenset({EDP_TWO}): [
                    MeasurementSet(
                        ...
                        impression = Measurement(8733867, 0, "measurement_151"),
                    ),
                    MeasurementSet(
                        ...
                        impression = Measurement(1911893, 0, "measurement_158"),
                    )
                ],
                frozenset({EDP_THREE}): [
                    MeasurementSet(
                        ...
                        impression = Measurement(1397418, 0, "measurement_165"),
                    ),
                    MeasurementSet(
                        ...
                        impression = Measurement(354251, 0, "measurement_172"),
                    )
                ],
                frozenset({EDP_ONE, EDP_TWO}): [
                    MeasurementSet(
                        reach = Measurement(13426464, 10000, "measurement_173"),
                        k_reach = {
                            1: Measurement(6929788, 10000, "measurement_174"),
                            2: Measurement(3464894, 10000, "measurement_175"),
                            3: Measurement(1732447, 10000, "measurement_176"),
                            4: Measurement(866224, 10000, "measurement_177"),
                            5: Measurement(433111, 10000, "measurement_178"),
                        },
                        impression = Measurement(26215389, 10000, "measurement_179"),
                    ),
                    MeasurementSet(
                        reach = Measurement(3278136, 10000, "measurement_180"),
                        k_reach = {
                            1: Measurement(1691941, 10000, "measurement_181"),
                            2: Measurement(845971, 10000, "measurement_182"),
                            3: Measurement(422986, 10000, "measurement_183"),
                            4: Measurement(211493, 10000, "measurement_184"),
                            5: Measurement(105745, 10000, "measurement_185"),
                        },
                        impression = Measurement(6135862, 10000, "measurement_186"),
                    )
                ],
            },
        ),
        "custom": MetricReport(
            ...
            whole_campaign_measurements=build_measurement_set(
                reach={
                    frozenset({EDP_ONE}): Measurement(12017026, 10000, "measurement_195"),
                    frozenset({EDP_TWO}): Measurement(6000000, 0, "measurement_196"),
                    frozenset({EDP_THREE}): Measurement(1000000, 0, "measurement_197"),
                    frozenset({EDP_ONE, EDP_TWO, EDP_THREE}):
                ...
                impression={
                    frozenset({EDP_ONE}): Measurement(22871159, 10000, "measurement_219"),
                    frozenset({EDP_TWO}): Measurement(11216125, 0, "measurement_220"),
                    frozenset({EDP_THREE}): Measurement(1844136, 0, "measurement_221"),
                    frozenset({EDP_ONE, EDP_TWO, EDP_THREE}):
            ...
            weekly_non_cumulative_measurements={
                frozenset({EDP_ONE}): [
                    MeasurementSet(
                        reach = Measurement(10000981, 10000, "measurement_223"),
                        k_reach = {
                            1: Measurement(5161797, 10000, "measurement_224"),
                            2: Measurement(2580899, 10000, "measurement_225"),
                            3: Measurement(1290450, 10000, "measurement_226"),
                            4: Measurement(645225, 10000, "measurement_227"),
                            5: Measurement(322610, 10000, "measurement_228"),
                        },
                        impression = Measurement(18382797, 10000, "measurement_229"),
                    ),
                    MeasurementSet(
                        reach = Measurement(2441042, 10000, "measurement_230"),
                        k_reach = {
                            1: Measurement(1259893, 10000, "measurement_231"),
                            2: Measurement(629947, 10000, "measurement_232"),
                            3: Measurement(314974, 10000, "measurement_233"),
                            4: Measurement(157487, 10000, "measurement_234"),
                            5: Measurement(78741, 10000, "measurement_235"),
                        },
                        impression = Measurement(4488362, 10000, "measurement_236"),
                    )
                ],
                frozenset({EDP_TWO}): [
                    MeasurementSet(
                        ...
                        impression = Measurement(9193546, 0, "measurement_243"),
                    ),
                    MeasurementSet(
                        ...
                        impression = Measurement(2022579, 0, "measurement_250"),
                    )
                ],
                frozenset({EDP_THREE}): [
                    MeasurementSet(
                        ...
                        impression = Measurement(1470967, 0, "measurement_257"),
                    ),
                    MeasurementSet(
                        ...
                        impression = Measurement(373169, 0, "measurement_264"),
                    )
                ],
                frozenset({EDP_ONE, EDP_TWO, EDP_THREE}): [
                    MeasurementSet(
                        reach = Measurement(15819974, 10000, "measurement_265"),
                        k_reach = {
                            1: Measurement(8165148, 10000, "measurement_266"),
                            2: Measurement(4082574, 10000, "measurement_267"),
                            3: Measurement(2041287, 10000, "measurement_268"),
                            4: Measurement(1020644, 10000, "measurement_269"),
                            5: Measurement(510321, 10000, "measurement_270"),
                        },
                        impression = Measurement(29052805, 10000, "measurement_271"),
                    ),
                    MeasurementSet(
                        reach = Measurement(3751542, 10000, "measurement_272"),
                        k_reach = {
                            1: Measurement(1936280, 10000, "measurement_273"),
                            2: Measurement(968140, 10000, "measurement_274"),
                            3: Measurement(484070, 10000, "measurement_275"),
                            4: Measurement(242035, 10000, "measurement_276"),
                            5: Measurement(121017, 10000, "measurement_277"),
                        },
                        impression = Measurement(6884110, 10000, "measurement_278"),
                    )
                ],
            },
        )
...
class TestReportMcApi2(unittest.TestCase):
    ...
    def test_report_with_inconsistent_number_of_cumulative_periods_raise_exception(self):
    ...
    def test_report_with_inconsistent_number_of_cumulative_and_non_cumulative_periods_raise_exception(self):
        with self.assertRaises(ValueError) as cm:
                ...
                metric_reports={
                    ...
                    "custom": MetricReport(
                        ...
                        weekly_non_cumulative_measurements={
                            frozenset({EDP_ONE}): [
                                MeasurementSet(
                                    reach=Measurement(15819974, 10000, "measurement_3"),
                                    k_reach={1: Measurement(8165148, 10000, "measurement_4")},
                                    impression=Measurement(29052805, 10000, "measurement_5"),
                                )
                            ],
                        },
                    ),
    ...
    def test_report_with_inconsistent_number_of_k_reach_frequencies_raise_exception(self):
        with self.assertRaises(ValueError) as cm:
                ...
                metric_reports={
                    "ami": MetricReport(
                        ...
                        whole_campaign_measurements={
                            frozenset({EDP_ONE}):
                                MeasurementSet(
                                    reach=Measurement(15819974, 10000, "measurement_6"),
                                    k_reach={
                                        1: Measurement(8165148, 10000, "measurement_7"),
                                    },
                                    impression=Measurement(29052805, 10000, "measurement_9"),
                                )
                        },
                        weekly_non_cumulative_measurements={},
                    ),
                        ...
                        weekly_non_cumulative_measurements={
                            frozenset({EDP_ONE}): [
                                MeasurementSet(
                                    reach=Measurement(15819974, 10000, "measurement_3"),
                                    k_reach={
                                        1: Measurement(8165148, 10000, "measurement_4"),
                                        2: Measurement(8165148, 10000, "measurement_8")
                                    },
                                    impression=Measurement(29052805, 10000, "measurement_5"),
                                )
                            ],
    ...
    def test_add_weekly_non_cumulative_measurements_to_spec(self):
        report = Report(
            metric_reports={
                "ami": MetricReport(
                    ...
                    whole_campaign_measurements=build_measurement_set(
                        reach={
                            frozenset({EDP_ONE}): Measurement(
                                11978894, 10000, "measurement_2"
                            ),
                        },
                        k_reach={},
                        impression={},
                ...
                "custom": MetricReport(
                    ...
                    weekly_non_cumulative_measurements={
                        frozenset({EDP_ONE, EDP_TWO, EDP_THREE}): [
                            MeasurementSet(
                                reach=Measurement(5819974, 10000, "measurement_8"),
                                k_reach={1: Measurement(165148, 10000, "measurement_9")},
                                impression=Measurement(9052805, 10000, "measurement_10"),
                            )
                        ],
                    },
                ),
        ...
        measurements_in_spec = {m[0].name : m[0] for m in spec._measurements_by_set.values()}
    ...
    def test_get_weekly_cumulative_reaches_return_correct_result(self):
        ...
        self.assertEqual(
            report._metric_reports[
                "ami"
            ].get_weekly_cumulative_reach_measurement(frozenset({EDP_TWO}), 1),
            None
        )
        self.assertEqual(
            report._metric_reports[
        ...
        self.assertEqual(
            report._metric_reports[
                "ami"
            ].get_weekly_cumulative_reach_measurement(frozenset({EDP_ONE}), 0),
            None
        )
    ...
    def test_get_weekly_non_cumulative_reaches_return_correct_result(self):
        ...
        self.assertEqual(
            report._metric_reports[
                "ami"
            ].get_weekly_non_cumulative_reach_measurement(
                frozenset({EDP_ONE}), 0),
    ...
    def test_get_weekly_non_cumulative_k_reach_measurements_return_correct_result(self):
        report = Report(
            metric_reports={
                "ami": MetricReport(
                    weekly_cumulative_reaches={
    ...
    def test_get_weekly_non_cumulative_impression_measurement_return_correct_result(self):
        report = Report(
            metric_reports={
                "ami": MetricReport(
                    weekly_cumulative_reaches={
