...
KINGDOM_INTERNAL_SERVICE_PROTOS = [
    ...
    "//src/main/proto/wfa/measurement/internal/kingdom:incidents_service_kt_jvm_grpc_proto",
...
KINGDOM_INTERNAL_ENTITY_PROTOS = [
    ...
    "//src/main/proto/wfa/measurement/internal/kingdom:incident_kt_jvm_proto",
