...
_eventGroupSpecs: [
	"/etc/\(#AppName)/config-files/synthetic_event_group_spec_4.textproto",
	"/etc/\(#AppName)/config-files/synthetic_event_group_spec_5.textproto",
	"/etc/\(#AppName)/config-files/synthetic_event_group_spec_6.textproto",
]
