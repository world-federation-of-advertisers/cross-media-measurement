...
_eventGroupSpecs: [
	"/etc/\(#AppName)/config-files/synthetic_event_group_spec_us_7.textproto",
	"/etc/\(#AppName)/config-files/synthetic_event_group_spec_us_8.textproto",
	"/etc/\(#AppName)/config-files/synthetic_event_group_spec_us_9.textproto",
]
