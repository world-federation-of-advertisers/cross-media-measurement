...
The following values are used for `app.kubernetes.io/component`: * `kingdom` *
`duchy` * `simulator` - For resources related to an EDP simulator. * `testing` -
For testing resources, e.g. Cloud emulators.
