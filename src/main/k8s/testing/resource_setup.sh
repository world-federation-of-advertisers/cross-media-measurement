...
--edp-result-signing-cert-der-files=edp1=src/main/k8s/testing/secretfiles/edp1_result_cs_cert.der \
--edp-result-signing-cert-der-files=edp2=src/main/k8s/testing/secretfiles/edp2_result_cs_cert.der \
--edp-result-signing-cert-der-files=edp3=src/main/k8s/testing/secretfiles/edp3_result_cs_cert.der \
--edp-result-signing-cert-der-files=edp4=src/main/k8s/testing/secretfiles/edp4_result_cs_cert.der \
--edp-result-signing-cert-der-files=edp5=src/main/k8s/testing/secretfiles/edp5_result_cs_cert.der \
--edp-result-signing-cert-der-files=edp6=src/main/k8s/testing/secretfiles/edp6_result_cs_cert.der \
--edp-result-signing-key-der-files=edp1=src/main/k8s/testing/secretfiles/edp1_result_cs_private.der \
--edp-result-signing-key-der-files=edp2=src/main/k8s/testing/secretfiles/edp2_result_cs_private.der \
--edp-result-signing-key-der-files=edp3=src/main/k8s/testing/secretfiles/edp3_result_cs_private.der \
--edp-result-signing-key-der-files=edp4=src/main/k8s/testing/secretfiles/edp4_result_cs_private.der \
--edp-result-signing-key-der-files=edp5=src/main/k8s/testing/secretfiles/edp5_result_cs_private.der \
--edp-result-signing-key-der-files=edp6=src/main/k8s/testing/secretfiles/edp6_result_cs_private.der \
