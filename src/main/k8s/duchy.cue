...
#Duchy: {
	...
	_async_computations_control_service_authority_flag: "--async-computation-control-service-authority=localhost"
	_computations_service_target_flag:                  "--computations-service-target=" + (#Target & {name: "\(_name)-spanner-computations-server"}).target
	_computations_service_authority_flag:               "--computations-service-authority=localhost"
	...
	_system_api_authority_flag:                         "--system-api-authority=localhost"
	...
	duchy_pod: {
		"herald-daemon-pod": #Pod & {
			_args: [
				...
				_computations_service_authority_flag,
				_duchy_name_flag,
		...
		"computation-control-server-pod": #ServerPod & {
			_args: [
				...
				_async_computations_control_service_authority_flag,
				_duchy_name_flag,
				_duchy_info_config_flag,
				_duchy_tls_cert_file_flag,
				_duchy_tls_key_file_flag,
