...
-- changeset tristanvuong2021:add-is-single-data-provider-col-measurements-table dbms:postgresql
ALTER TABLE Measurements ADD COLUMN IsSingleDataProvider boolean NOT NULL DEFAULT FALSE;
