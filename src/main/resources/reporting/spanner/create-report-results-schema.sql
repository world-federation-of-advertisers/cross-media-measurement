...
--changeset kungfucraig:8 dbms:cloudspanner
...
ALTER PROTO BUNDLE INSERT (
  ...
  `wfa.measurement.internal.reporting.v2.ReportResult.ReportingSetResultsEntry`,
);
...
-- Ensure uniqueness by ReportingSet.
CREATE UNIQUE INDEX ReportingSetResultsByExternalId ON ReportingSetResults
  (MeasurementConsumerId, ReportingResultId, ExternalReportingSetId);
