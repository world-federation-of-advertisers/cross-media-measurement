...
resource "google_monitoring_service" "secure_computation_apis" {
...
resource "google_monitoring_service_level_objective" "api_availability_99_9_28d" {
  service      = google_monitoring_service.secure_computation_apis.name
