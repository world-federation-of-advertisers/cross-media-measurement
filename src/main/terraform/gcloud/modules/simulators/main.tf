...
locals {
  kms_keyring_name                = "${var.simulator_name}-keyring-test3"
  ...
  workload_identity_pool_id       = "${var.simulator_name}-wip-test3"
  workload_identity_pool_name     = "${var.simulator_name}-wip-test3"
  workload_identity_provider_id   = "provider-test3"
  workload_identity_provider_name = "provider-test3"
}
