...
resource "google_monitoring_service" "data_availability_sync" {
...
resource "google_monitoring_service" "results_fulfiller" {
...
resource "google_monitoring_service" "event_group_sync" {
...
resource "google_monitoring_service_level_objective" "data_availability_freshness_99_9_28d" {
  service      = google_monitoring_service.data_availability_sync.name
...
resource "google_monitoring_service_level_objective" "requisition_fulfillment_timeliness_99_9_28d" {
  service      = google_monitoring_service.results_fulfiller.name
...
resource "google_monitoring_service_level_objective" "fulfillment_correctness_99_99_28d" {
  service      = google_monitoring_service.results_fulfiller.name
...
resource "google_monitoring_service_level_objective" "event_group_sync_timeliness_99_9_28d" {
  service      = google_monitoring_service.event_group_sync.name
