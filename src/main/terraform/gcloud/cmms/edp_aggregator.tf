...
locals {
  secrets = {
    ...
    edpa_tee_app_trusted_ca = {
      secret_id         = "edpa-tee-app-trusted-ca"
  ...
  queue_worker_configs = {
    requisition_fulfiller = {
      ...
      worker = {
        ...
        docker_image                = "ghcr.io/world-federation-of-advertisers/edp-aggregator/results_fulfiller:31660efa74bdcadd78a74103fac68a4e073232fa"
        secrets_to_mount            = [
          {
