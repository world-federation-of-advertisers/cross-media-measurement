...
module "edp_aggregator" {
  ...
  requisition_fetcher_scheduler_service_account_name = "edpa-requisition-fetcher-scheduler"
  requisition_fetcher_schedule                       = "*/5 * * * *"
  requisition_fetcher_schedule_timezone              = "UTC"
