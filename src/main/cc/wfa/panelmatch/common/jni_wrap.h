...
#ifndef SRC_MAIN_CC_WFA_PANELMATCH_COMMON_JNI_WRAP_H_
#define SRC_MAIN_CC_WFA_PANELMATCH_COMMON_JNI_WRAP_H_

#include <string>

#include "absl/status/statusor.h"
#include "util/status_macros.h"
#include "wfa/panelmatch/common/deserialize_proto.h"

namespace wfa::panelmatch::common {
...
#endif  // SRC_MAIN_CC_WFA_PANELMATCH_COMMON_JNI_WRAP_H_
