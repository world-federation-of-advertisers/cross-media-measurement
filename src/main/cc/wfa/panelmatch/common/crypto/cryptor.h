...
#ifndef SRC_MAIN_CC_WFA_PANELMATCH_COMMON_CRYPTO_CRYPTOR_H_
#define SRC_MAIN_CC_WFA_PANELMATCH_COMMON_CRYPTO_CRYPTOR_H_
...
#endif  // SRC_MAIN_CC_WFA_PANELMATCH_COMMON_CRYPTO_CRYPTOR_H_
