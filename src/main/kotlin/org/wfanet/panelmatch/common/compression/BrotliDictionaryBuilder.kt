...
/** [DictionaryBuilder] that uses Brotli compression (via JNI). */
class BrotliDictionaryBuilder : DictionaryBuilder {
  // TODO(@efoxepstein): experimentally adjust this value
  override val preferredSampleSize: Int = 1000

  override val factory: CompressorFactory = BrotliCompressorFactory()
