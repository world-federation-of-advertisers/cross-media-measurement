...
class InProcessDuchy(
  ...
  private val trusTeeKmsClient: KmsClient? = null, // TODO(@dawn-wang22): Remove default and make this a required param after all callers provide a KmsClient.
      ...
      daemonScope.launch(CoroutineName("$externalDuchyId Mill")) {
        ...
        val reachFrequencyLiquidLegionsV2Mill =
          ReachFrequencyLiquidLegionsV2Mill(
            ...
            consentSignalCert = Certificate(duchyCertMap.getValue(externalDuchyId), consentSignal509Cert),
