...
import org.wfanet.measurement.kingdom.deploy.common.service.withApiKeysServerInterceptor
  ...
  private val internalDataServer =
    GrpcTestServerRule(logAllRequests = verboseGrpcLogging) {
      ...
      kingdomDataServices.buildDataServices().toList().forEach {
        when (it) {
          is ApiKeysCoroutineImplBase ->
            addService(it.withApiKeysServerInterceptor().withVerboseLogging(verboseGrpcLogging))
