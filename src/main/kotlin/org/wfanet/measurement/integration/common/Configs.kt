...
val ALL_EDP_WITH_HMSS_CAPABILITIES_DISPLAY_NAMES = listOf("edp1", "edp2", "edp3")
val ALL_EDP_WITHOUT_HMSS_CAPABILITIES_DISPLAY_NAMES = emptyList<String>() //listOf("edp2")
