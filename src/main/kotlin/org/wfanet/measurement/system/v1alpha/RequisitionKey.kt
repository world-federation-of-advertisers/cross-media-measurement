...
private val parser = ResourceNameParser("computations/{computation}/requisitions/{requisition}")

/** [ResourceKey] of a Requisition. */
data class RequisitionKey(val computationId: String, val requisitionId: String) : ResourceKey {
  override fun toName(): String {
    return parser.assembleName(
      mapOf(IdVariable.COMPUTATION to computationId, IdVariable.REQUISITION to requisitionId)
    )
  }
