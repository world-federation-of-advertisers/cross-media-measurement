...
/** The parameters used to compute the variance of a reach-frequency measurement. */
...
/** A data class that wraps different types of variances of a reach-frequency measurement. */
