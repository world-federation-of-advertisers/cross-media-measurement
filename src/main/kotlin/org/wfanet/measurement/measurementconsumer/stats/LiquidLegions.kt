...
/** Contains functions to compute statistics of Liquid Legions based measurements. */
object LiquidLegions {
  ...
  /** The covariance between two LiquidLegions-based reaches with an inflation term. */
   ...
   */
  fun liquidLegionsRelativeVariance(
    sketchParams: LiquidLegionsSketchParams,
    collisionResolution: Boolean,
   ...
   */
  fun liquidLegionsCountVariance(
    totalReach: Int,
