 ...
 *
 * Note that the calculation is under the assumption that EDP counts do not depend on sketch.
 */
  ...
  protected fun calculateScalarMeasurementVariance(
    ...
    val variance =
      (maximumFrequencyPerUser *
        ...
        (1 - vidSamplingIntervalWidth) + maximumFrequencyPerUser.pow(2) * gaussianNoiseVariance) /
