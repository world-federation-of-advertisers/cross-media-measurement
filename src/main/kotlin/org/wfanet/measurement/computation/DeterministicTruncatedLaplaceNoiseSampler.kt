...
class DeterministicTruncatedLaplaceNoiseSampler(
   ...
   * those bits. [StrictMath.rint] is round-half-to-even and IEEE-754 exact (no libm), so the rounded
   * result stays bit-reproducible across JVMs like the draw it rounds.
   */
