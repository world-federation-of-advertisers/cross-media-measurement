...
class TruncatedLaplaceNoiseDistribution(
   ...
   * an uneven lattice of representable doubles whose low bits depend on the true value being
   * noised, which breaks differential privacy (Mironov, "On Significance of the Least Significant
   * Bits for Differential Privacy", CCS 2012, https://dl.acm.org/doi/10.1145/2382196.2382264).
   * Round the draw to an integer before release;
   * [DeterministicTruncatedLaplaceNoiseSampler.sampleRounded] does this. The method is exposed only
   * for the sampler and for reproducibility tests.
   */
