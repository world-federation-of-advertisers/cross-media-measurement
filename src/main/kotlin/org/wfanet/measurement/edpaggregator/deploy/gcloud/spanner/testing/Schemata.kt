...
package org.wfanet.measurement.edpaggregator.deploy.gcloud.spanner.testing

import java.nio.file.Path
import org.wfanet.measurement.common.getJarResourcePath

object Schemata {
  private const val RESOURCE_PREFIX = "edpaggregator/spanner"
  ...
  val EDP_AGGREGATOR_CHANGELOG_PATH: Path = getResourcePath("changelog.yaml")
}
