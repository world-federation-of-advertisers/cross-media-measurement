 ...
 * - `STALENESS_THRESHOLD_SECONDS`: Optional. Uploads non-terminal longer than this are
 *   flagged as stuck (default: 24h).
...
class VidLabelingMonitorFunction : HttpFunction {
  ...
  companion object {
    ...
    private const val DEFAULT_STALENESS_THRESHOLD_SECONDS: Long = 24L * 60L * 60L
    ...
    private val stalenessThreshold =
      Duration.ofSeconds(
        System.getenv("STALENESS_THRESHOLD_SECONDS")?.toLong()
