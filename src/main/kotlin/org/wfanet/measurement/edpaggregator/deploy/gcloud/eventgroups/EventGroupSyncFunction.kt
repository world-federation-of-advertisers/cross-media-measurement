...
import org.wfanet.measurement.edpaggregator.telemetry.trace
import org.wfanet.measurement.edpaggregator.telemetry.traceSuspending
import org.wfanet.measurement.edpaggregator.telemetry.withW3CTraceContext
...
class EventGroupSyncFunction() : HttpFunction {
  ...
  override fun service(request: HttpRequest, response: HttpResponse) {
    try {
      ...
      withW3CTraceContext(request) {
        trace(spanName = SPAN_EVENT_GROUP_SYNC) {
  ...
  companion object {
    ...
    private val ATTR_DATA_PROVIDER_NAME = AttributeKey.stringKey("edpa.data_provider_name")
