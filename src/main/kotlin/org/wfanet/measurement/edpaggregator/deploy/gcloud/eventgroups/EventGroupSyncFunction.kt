...
class EventGroupSyncFunction() : HttpFunction {
   ...
   * [JsonFormat]. This avoids materializing the entire file as a String and the entire
  ...
  private suspend fun getEventGroupsFromJsonFormat(
    ...
    // `newInput()` reads over the (possibly rope) ByteString lazily, without forcing a contiguous
    // copy or a full UTF-8 String of the blob.
    var count = 0
