...
class EventGroupSyncFunction() : HttpFunction {
    ...
    try {
      ...
      runBlocking {
        TracedOperation.trace(
          ...
          val eventGroupsClient = createKingdomEventGroupsStub(
   ...
   *
   * @param mappedData Flow of MappedEventGroup containing event group reference IDs and resource names
  ...
  companion object {
     ...
     */
    private fun createKingdomEventGroupsStub(
      target: String,
      eventGroupSyncConfig: EventGroupSyncConfig,
      certHost: String?,
