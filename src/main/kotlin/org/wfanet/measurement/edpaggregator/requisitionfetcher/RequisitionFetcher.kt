...
class RequisitionFetcher(
  ...
  private suspend fun withStoreTelemetry(
    ...
    Tracing.trace(
      ...
      if (result.exception == null) {
        ...
        return@trace result.storedCount
      }
      ...
      Span.current()
        .addEvent(
          ...
          Attributes.of(
            ...
            STATUS_FAILURE,
            ATTR_ERROR_TYPE_KEY,
            exception::class.simpleName ?: exception::class.java.simpleName ?: exception::class.java.name,
          ),
        )
  ...
  private suspend fun withStorageTelemetry(
    ...
    Tracing.trace(spanName = SPAN_STORE_GROUPED_REQUISITION, attributes = spanAttributes) {
      logger.info(
  ...
  companion object {
    ...
    private val ATTR_GROUPED_COUNT_KEY = AttributeKey.longKey("grouped_requisition_count")
    private val ATTR_STORAGE_COUNT_KEY = AttributeKey.longKey("storage_success_count")
    private val ATTR_GROUPED_REQUISITION_ID_KEY = AttributeKey.stringKey("grouped_requisition_id")
    ...
    private const val SPAN_FETCH_REQUISITIONS = "requisition_fetch"
    private const val SPAN_STORE_REQUISITIONS = "requisition_store"
    private const val SPAN_STORE_GROUPED_REQUISITION = "store_grouped_requisition"
