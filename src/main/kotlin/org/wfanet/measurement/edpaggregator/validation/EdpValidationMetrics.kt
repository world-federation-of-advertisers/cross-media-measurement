...
class EdpValidationMetrics(meter: Meter = Instrumentation.meter) {
  ...
  /** Counter for reports by aggregate [EdpValidationPostProcessor.ReportValidationResult]. */
  val reportResultsCounter: LongCounter =
    meter
      .counterBuilder("edp_validation.report_results")
      .setDescription("Reports by aggregate validation result")
      .build()
  ...
  companion object {
    ...
    val RESULT_KEY: AttributeKey<String> = AttributeKey.stringKey("edp_validation.result")
  }
}
