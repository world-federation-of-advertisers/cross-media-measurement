...
import org.wfanet.measurement.internal.edpaggregator.rawImpressionMetadataBatch as internalBatch
      ...
      try {
        internalBatchStub.createRawImpressionMetadataBatch(
          internalCreateBatchRequest {
            rawImpressionMetadataBatch = internalBatch {
...
internal fun RawImpressionBatchState.toPublic(): RawImpressionMetadataBatch.State {
  return when (this) {
    ...
    RawImpressionBatchState.RAW_IMPRESSION_BATCH_STATE_UNSPECIFIED ->
      RawImpressionMetadataBatch.State.STATE_UNSPECIFIED
  }
}
