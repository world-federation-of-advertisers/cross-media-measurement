...
class DataAvailabilitySync(
        ...
        throttler.onReady {
          try {
            ...
            metrics.cmmsRpcErrorsCounter.add(
              1,
              Attributes.of(
                DATA_PROVIDER_KEY_ATTR, dataProviderName,
                RPC_METHOD_ATTR, RPC_METHOD_REPLACE_DATA_AVAILABILITY_INTERVALS,
                STATUS_CODE_ATTR, e.status.code.name,
              )
            )
  ...
  companion object {
    ...
    private val DATA_PROVIDER_KEY_ATTR: AttributeKey<String> =
      AttributeKey.stringKey("data_provider_key")
    private val STATUS_ATTR: AttributeKey<String> = AttributeKey.stringKey("status")
    private val RPC_METHOD_ATTR: AttributeKey<String> = AttributeKey.stringKey("rpc_method")
    private val STATUS_CODE_ATTR: AttributeKey<String> = AttributeKey.stringKey("status_code")
