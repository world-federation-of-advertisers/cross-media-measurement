...
class VidLabelingMonitor(
  ...
  suspend fun run(): MonitorResult {
    val dispatch: VidLabelingDispatchSequencer.DispatchResult = dispatchSequencer.dispatchNext()
    ...
    } else if (dispatch.queuedUploads > 0) {
      VidLabelingMonitorMetrics.uploadsQueuedCounter.add(
