...
class SubpoolAssignerAppRunner : BaseVidLabelingTeeAppRunner() {
  ...
  override fun run() {
    ...
    val subpoolAssignerApp =
      SubpoolAssignerApp(
        ...
        loadPoolEmitLabeler = { modelBlobPath ->
          VirtualPeoplePoolEmitLabeler.fromCompiledNodeBlob(readCompiledModelBlob(modelBlobPath))
        },
