...
/**
 * Strategy interface for selecting a [MeasurementFulfiller] given requisition context.
 */
interface FulfillerSelector {
  /**
   * Selects and builds a [MeasurementFulfiller] for the given requisition and inputs.
   */
