...
class FakeEventReader(
  ...
  companion object {
     ...
     */
    private fun createFakeLabeledEvent(id: String): LabeledEvent<DynamicMessage> {
      // Create a minimal DynamicMessage for testing
      val fakeMessage = DynamicMessage.getDefaultInstance(
        Empty.getDescriptor()
      ) as DynamicMessage
...
class FakeEventReaderFactory(
  ...
  companion object {
     ...
     */
    fun withMappings(mappings: Map<Pair<String, String>, EventReader>): FakeEventReaderFactory {
