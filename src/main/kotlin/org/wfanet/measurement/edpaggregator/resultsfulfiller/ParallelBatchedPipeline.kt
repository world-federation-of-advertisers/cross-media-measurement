 ...
 * - Each worker processes its assigned batch through ALL filters sequentially
 *
 * ### Key Components:
 ...
 * - Sequential filter evaluation per batch for better cache locality
 */
    ...
    val processingJobs = workerChannels.mapIndexed { index, channel ->
      ...
      launch(dispatcher) {
        ...
        for (batch in channel) {
          // Process batch through all filters sequentially for better cache locality
          sinks.forEach { sink ->
