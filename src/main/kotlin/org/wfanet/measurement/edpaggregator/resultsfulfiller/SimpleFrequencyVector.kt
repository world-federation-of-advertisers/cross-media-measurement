...
/**
 * Simple implementation of FrequencyVector for temporary compatibility.
 * 
 * This is a basic implementation to allow ResultsFulfiller to work with the new
 * FrequencyVector interface without requiring complex PopulationSpec creation.
 * 
 * @param vids List of VIDs to include in the frequency vector
 */
class SimpleFrequencyVector(vids: List<Long>) : FrequencyVector {
  ...
  override fun merge(other: FrequencyVector): FrequencyVector {
    ...
    return SimpleFrequencyVector(mergedVids)
  }
  ...
  override fun sample(rate: Double, random: SecureRandom): FrequencyVector {
    ...
    return SimpleFrequencyVector(sampledVids)
  }
}