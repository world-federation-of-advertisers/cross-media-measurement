 ...
 * @property descriptor Protobuf descriptor for the event message.
...
class StorageEventReader(
  ...
  private val bufferCapacity: Int = DEFAULT_BUFFER_SIZE,
) : EventReader {
   ...
   *
   * @return a [Flow] emitting lists of [LabeledEvent] with [Message] content.
  ...
  companion object {
    ...
    const val DEFAULT_BUFFER_SIZE = DEFAULT_BATCH_SIZE * 4
  }
}
