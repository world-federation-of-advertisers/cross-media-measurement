      ...
      return eventGroupDetailsList
        .flatMap { eventGroupDetails ->
          eventGroupDetails.collectionIntervalsList.flatMap { interval ->
            ...
            // Handle edge case where start and end are the same or very close (e.g., single day at midnight)
            if (startDate.isAfter(endDate) || startDate.isEqual(endDate)) {
              // The interval spans exactly one day or less, include just the start date
              listOf(EventGroupDate(
