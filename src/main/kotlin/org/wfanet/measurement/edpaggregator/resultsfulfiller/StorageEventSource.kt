...
class StorageEventSource(
  ...
  companion object {
    ...
    /**
     * Extension function to convert protobuf Timestamp to LocalDate in UTC.
     * Always uses UTC timezone for consistent date processing.
     */
  ...
  private suspend fun createEventReaders(): List<EventReaderInfo> {
    val dates = StorageEventSource.expandEventGroupDates(eventGroupDetailsList)
