 ...
 *
 * Resolves per-day metadata paths, reads [BlobDetails] messages from
...
class StorageImpressionMetadataService(
  ...
  fun resolvePath(
    ...
    return "${impressionsBlobDetailsUriPrefix}ds/$date/model-line/${modelLine}/event-group-reference-id/$eventGroupReferenceId/metadata"
  }
