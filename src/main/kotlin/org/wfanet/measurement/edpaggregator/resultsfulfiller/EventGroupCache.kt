...
class EventGroupCache(
  ...
  private data class EventGroupKey(val ds: LocalDate, val eventGroupId: String)
      ...
      .build(
        object : CacheLoader<EventGroupKey, List<LabeledImpression>>() {
          override fun load(key: EventGroupKey): List<LabeledImpression> {
            ...
            return runBlocking {
              val blobDetails = fetchBlobDetails(key.ds, key.eventGroupId)
   ...
   */
  private suspend fun fetchBlobDetails(ds: LocalDate, eventGroupId: String): BlobDetails {
