...
object EdpaTelemetry {
   ...
   *
   * Automatically called during object initialization using environment variables. Idempotent -
   ...
   *
   * **Performance**: Flushes metrics and traces in parallel to minimize latency. Total flush time =
   * max(metric_flush_time, trace_flush_time) rather than sum.
   *
   * Example:
   * ```
