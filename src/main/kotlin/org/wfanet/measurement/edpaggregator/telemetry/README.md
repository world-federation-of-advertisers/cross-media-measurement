...
import org.wfanet.measurement.edpaggregator.telemetry.info
import org.wfanet.measurement.edpaggregator.telemetry.severe

private val logger = EdpaTelemetry.getLogger("my-component")

logger.info("Processing started", Attributes.builder()
  .put("user_id", userId)
  .build())

logger.severe("Processing failed", throwable = e)
```

Logs export to stdout → Google Cloud Logging. Automatically correlated with traces.
