 ...
 * [CheckPermissionsRequest.principal][CheckPermissionsRequest.getPrincipal].
 */
class PrincipalMatcher(private val principalName: String) :
  ...
  override fun matches(argument: CheckPermissionsRequest?): Boolean {
    ...
    return argument.principal == principalName
  }

  companion object {
    fun hasPrincipal(principalName: String) = argThat(PrincipalMatcher(principalName))
  }
}
