...
class CheckPermissions : Runnable {
  ...
  @Option(
    ...
    description =
      [
        "Name of the resource on which to check permissions. If not specified, this means the root of the protected API."
      ],
    defaultValue = "",
    required = false,
  )
  ...
  @Option(names = ["--permission"], description = ["Set of permissions to check"], required = true)
  private lateinit var permissionList: List<String>
