...
import org.wfanet.measurement.access.service.v1alpha.PrincipalsService
import org.wfanet.measurement.access.service.v1alpha.RolesService
...
class PublicApiServer : Runnable {
  ...
  override fun run() {
    ...
    val services: List<BindableService> =
      listOf(
        PrincipalsService(InternalPrincipalsGrpcKt.PrincipalsCoroutineStub(internalApiChannel)),
        RolesService(InternalRolesGrpcKt.RolesCoroutineStub(internalApiChannel)),
        // TODO(@roaminggypsy): Add remaining services.
      )
