    ...
    runBlocking {
      spannerFlags.usingSpanner { spanner ->
        ...
        val services: List<BindableService> =
          listOf(
            SpannerPrincipalsService(databaseClient, tlsClientMapping),
            SpannerPermissionsService(databaseClient, permissionMapping, tlsClientMapping),
            SpannerRolesService(databaseClient, permissionMapping),
            SpannerPoliciesService(databaseClient, tlsClientMapping),
          )
