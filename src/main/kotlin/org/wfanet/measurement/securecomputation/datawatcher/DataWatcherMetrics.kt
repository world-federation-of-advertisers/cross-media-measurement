 ...
 * @param configIdentifierKey Attribute key for config identifier (values come from each
 *   [WatchedPath] entry in the watcher config). Cardinality: equals the number of watched path
 *   configs.
