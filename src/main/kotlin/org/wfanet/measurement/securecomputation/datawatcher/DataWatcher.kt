...
class DataWatcher(
  ...
  companion object {
    ...
    private val ATTR_CONFIG_IDENTIFIER_KEY = AttributeKey.stringKey("edpa.data_watcher.config_identifier")
    ...
    private val ATTR_DURATION_SECONDS_KEY = AttributeKey.doubleKey("edpa.data_watcher.processing_duration_seconds")
    private val ATTR_SOURCE_PATH_REGEX_KEY = AttributeKey.stringKey("edpa.data_watcher.source_path_regex")
