...
abstract class WorkItemsServiceTest<T : WorkItemsCoroutineImplBase> {

  protected data class Services<T>(
    val workItemsService: T
  )

  protected val clock: Clock = Clock.systemUTC()
  protected val idGenerator = RandomIdGenerator(clock, Random(RANDOM_SEED))

  protected lateinit var workItemsService: T
    private set
  ...
  fun initServices() {
    ...
    workItemsService = services.workItemsService
  }
