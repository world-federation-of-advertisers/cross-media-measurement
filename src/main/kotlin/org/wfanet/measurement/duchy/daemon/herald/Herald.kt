...
class Herald(
  ...
  /**
   * Attempt the block once and if that fails, launches a coroutine to continue retrying in the
   * background. Retrying is necessary since there is a race condition between the mill updating
   * computation state and kingdom pushing globalComputation update to the herald.
   */
