...
class LiquidLegionsV2Mill(
  ...
  /** Process computation in the initialization phase */
  private suspend fun initializeComputation(token: ComputationToken): ComputationToken {
    ...
    val nextToken =
      if (llv2ComputationDetails.hasLocalElgamalKey()) {
        // Reuses the key if it is also generated for this computation.
        token
      } else {
        ...
        // Update the newly calculated localElgamalKey to the ComputationDetails.
