...
import org.wfanet.measurement.duchy.daemon.utils.PublicApiVersions
import org.wfanet.measurement.duchy.daemon.utils.toPublicApiVersions
...
object LiquidLegionsV2Starter {
  ...
  private fun Computation.toLiquidLegionsV2Parameters(
    ...
    require(configMaps.containsKey(protocolConfigId)) {
      "ProtocolConfig $protocolConfigId not found."
    }
    val publicProtocolConfig = configMaps[protocolConfigId]!!
        ...
        it.noiseBuilder.apply {
          reachNoiseConfigBuilder.apply {
            blindHistogramNoiseBuilder.apply {
              epsilon = duchyProtocolConfig.liquidLegionsV2.mpcNoise.blindedHistogramNoise.epsilon
              delta = duchyProtocolConfig.liquidLegionsV2.mpcNoise.blindedHistogramNoise.delta
            }
            noiseForPublisherNoiseBuilder.apply {
              epsilon = duchyProtocolConfig.liquidLegionsV2.mpcNoise.noiseForPublisherNoise.epsilon
              delta = duchyProtocolConfig.liquidLegionsV2.mpcNoise.noiseForPublisherNoise.delta
            }
          }
          when (publicApiVersion.toPublicApiVersions()) {
            PublicApiVersions.V2_ALPHA -> {
              ...
              reachNoiseConfigBuilder.globalReachDpNoiseBuilder.apply {
                epsilon = measurementSpec.reachAndFrequency.reachPrivacyParams.epsilon
                delta = measurementSpec.reachAndFrequency.reachPrivacyParams.delta
              }
              frequencyNoiseConfigBuilder.apply {
                epsilon = measurementSpec.reachAndFrequency.frequencyPrivacyParams.epsilon
                delta = measurementSpec.reachAndFrequency.frequencyPrivacyParams.delta
              }
            }
          }
        }
