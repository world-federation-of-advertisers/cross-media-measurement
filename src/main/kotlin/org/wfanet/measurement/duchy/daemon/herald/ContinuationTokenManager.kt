...
class ContinuationTokenManager(
  ...
  suspend fun markTokenProcessed(continuationToken: String) {
    var updatedLatestContinuationToken = ""
    ...
    synchronized(this) {
      ...
      updatedLatestContinuationToken = leadingProcessedTokens.last()
    ...
    continuationTokenClient.setContinuationToken(
      setContinuationTokenRequest { this.token = updatedLatestContinuationToken }
    )
  }
}
