...
interface ProtocolStageDetails<StageT, StageDetailsT, ComputationDetailsT> {
  ...
  fun detailsFor(stage: StageT, computationDetail: ComputationDetailsT?): StageDetailsT
  ...
  fun outputBlobNumbersForStage(stage: StageT, computationDetail: ComputationDetailsT): Int
}
