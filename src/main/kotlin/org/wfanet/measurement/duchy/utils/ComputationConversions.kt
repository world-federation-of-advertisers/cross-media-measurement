    ...
    return MeasurementKt.result {
                  ...
                  CustomDirectMethodologyKt.variance {
                    this.frequency =
                      CustomDirectMethodologyKt.VarianceKt.frequencyVariances {
                        for ((frequency, variance) in source.methodology.relativeVariances) {
                          variances[frequency.toLong()] = variance
                        }
                        for ((frequency, variance) in source.methodology.kPlusRelativeVariances) {
                          kPlusVariances[frequency.toLong()] = variance
                        }
                      }
                  }
              }
      ...
      frequency =
        MeasurementKt.ResultKt.frequency {
          ...
          when (source.methodology) {
            is CustomDirectFrequencyMethodology -> {
              customDirectMethodology = source.methodology.toV2Alpha()
            }
            is DeterministicMethodology -> {
      ...
      reach = run {
        ...
        MeasurementKt.ResultKt.reach {
          ...
          when (methodology) {
            ...
            is LiquidLegionsSketchMethodology -> {
              liquidLegionsCountDistinct = liquidLegionsCountDistinct {
                decayRate = methodology.decayRate
                maxSize = methodology.sketchSize
              }
            }
            ...
            is CustomDirectScalarMethodology -> {
              customDirectMethodology = customDirectMethodology {
                variance =
                  CustomDirectMethodologyKt.variance { scalar = source.methodology.variance }
              }
            }
          }
        }
...
private fun CustomDirectFrequencyMethodology.toV2Alpha(): CustomDirectMethodology {
  val source = this
  return customDirectMethodology {
    variance =
      CustomDirectMethodologyKt.variance {
        this.frequency =
          CustomDirectMethodologyKt.VarianceKt.frequencyVariances {
            for ((frequency, variance) in source.relativeVariances) {
              variances[frequency.toLong()] = variance
            }
            for ((frequency, variance) in source.kPlusRelativeVariances) {
              kPlusVariances[frequency.toLong()] = variance
            }
          }
      }
