...
@CommandLine.Command(
  ...
  description = ["Forwarded storage herald daemon."],
  mixinStandardHelpOptions = true,
  showDefaultValues = true,
)
class ForwardedStorageHeraldDaemon : HeraldDaemon() {
...
fun main(args: Array<String>) = commandLineMain(ForwardedStorageHeraldDaemon(), args)
