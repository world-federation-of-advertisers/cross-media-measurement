...
class ContinuationTokenTransactor(val databaseClient: AsyncDatabaseClient, val duchyName: String) :
  ...
  override suspend fun writeContinuationToken(continuationToken: String) {
...
/** @see [ContinuationTokenTransactor.asResult] . */
