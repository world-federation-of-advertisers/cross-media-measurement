...
class ForwardedStorageHonestMajorityShareShuffleMillDaemon : HonestMajorityShareShuffleMillDaemon() {
...
fun main(args: Array<String>) = commandLineMain(ForwardedStorageHonestMajorityShareShuffleMillDaemon(), args)
