...
class KingdomV2alphaPublicApiFlags {
  @CommandLine.Option(
    names = ["--kingdom-v2alpha-public-api-target"],
    description = ["Address and port of the Kingdom's v2alpha public APIs"],
    required = true
  )
  ...
  @CommandLine.Option(
    names = ["--kingdom-v2alpha-public-api-cert-host"],
    description =
      ["The expected hostname in the kingdom v2alpha PublicApiServer's TLS certificate."],
    required = true
  )
