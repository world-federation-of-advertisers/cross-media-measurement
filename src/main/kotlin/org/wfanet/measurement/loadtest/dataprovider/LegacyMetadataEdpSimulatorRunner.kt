...
class LegacyMetadataEdpSimulatorRunner : AbstractEdpSimulatorRunner<LegacyMetadataEdpSimulator>() {
  @CommandLine.Option(
  ...
  override fun getSyntheticDataSpec(eventGroup: EventGroup): SyntheticEventGroupSpec {
    ...
    return eventGroupSpecByReferenceIdSuffix.getValue(referenceIdSuffix)
  }
  ...
  override suspend fun LegacyMetadataEdpSimulator.ensureEventGroups() {
    ...
    ensureEventGroups(eventTemplates, metadataByReferenceIdSuffix)
  }
