...
class EdpValidationMetrics(meter: Meter = Instrumentation.meter) {
  ...
  companion object {
    ...
    val SKIP_REASON_KEY: AttributeKey<String> =
      AttributeKey.stringKey("edp_validation.skip_reason")
    val ERROR_TYPE_KEY: AttributeKey<String> =
      AttributeKey.stringKey("edp_validation.error_type")
  }
}
