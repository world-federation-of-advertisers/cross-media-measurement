...
class CreateReportingSet(private val request: CreateReportingSetRequest) :
  ...
  override suspend fun TransactionScope.runTransaction(): ReportingSet {
    ...
    val batchGetReportingSetsRequest: BatchGetReportingSetsRequest = batchGetReportingSetsRequest {
      cmmsMeasurementConsumerId = request.reportingSet.cmmsMeasurementConsumerId
      externalReportingSetIds += request.externalReportingSetId
    }
    if (
