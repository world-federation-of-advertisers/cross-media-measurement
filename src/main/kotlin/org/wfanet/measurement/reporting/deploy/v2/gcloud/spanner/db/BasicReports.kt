...
fun AsyncDatabaseClient.TransactionContext.insertBasicReport(
  ...
  bufferInsertMutation("BasicReports") {
    ...
    set("AmiMrcExemptedEdps").toStringArray(basicReport.amiMrcExemptedCmmsDataProviderIdsList)
  }
}
...
private fun buildBasicReport(row: Struct): BasicReport {
  return basicReport {
    ...
    amiMrcExemptedCmmsDataProviderIds += row.getStringList("AmiMrcExemptedEdps")
  }
}
