...
package org.wfanet.measurement.reporting.deploy.v2.postgres.testing

import java.nio.file.Path
import org.wfanet.measurement.common.getJarResourcePath

object Schemata {
  private const val REPORTING_POSTGRES_RESOURCE_PREFIX = "reporting/postgres"

  private fun getResourcePath(fileName: String): Path {
    val resourceName = "$REPORTING_POSTGRES_RESOURCE_PREFIX/$fileName"
