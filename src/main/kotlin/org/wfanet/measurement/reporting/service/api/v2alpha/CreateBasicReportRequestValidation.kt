...
object CreateBasicReportRequestValidation {
  ...
  data class ParsedFields(val parentKey: MeasurementConsumerKey)
  ...
  private fun validateEventTemplateFieldValue(
    eventTemplateField: EventTemplateField,
    fieldPath: String,
    eventTemplateFieldInfo: EventDescriptor.EventTemplateFieldInfo,
  ) {
