 ...
 */
class MeasurementConsumerServerInterceptor(private val apiKeyLookup: ApiKeyLookup) : ServerInterceptor {
...
fun BindableService.withMeasurementConsumerServerInterceptor(
  apiKeyLookup: MeasurementConsumerServerInterceptor.ApiKeyLookup
): ServerServiceDefinition =
  ServerInterceptors.interceptForward(
    this,
    MeasurementConsumerServerInterceptor(apiKeyLookup)
  )
