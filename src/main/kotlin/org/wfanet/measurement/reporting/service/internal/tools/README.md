...
Like all Halo command line tools, this tool supports argument files. This means
you can put all of your arguments in a file and provide it to the tool using
"@file" syntax. See https://picocli.info/#AtFiles.
