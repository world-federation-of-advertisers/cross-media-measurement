...
import org.wfanet.measurement.internal.reporting.v2.ReportResultKt.ReportingSetResultKt.ReportingWindowResultKt.NoisyReportResultValuesKt.NoisyMetricSetKt
import org.wfanet.measurement.internal.reporting.v2.ReportResultKt.ReportingSetResultKt.ReportingWindowResultKt.NoisyReportResultValuesKt.noisyMetricSet
import org.wfanet.measurement.internal.reporting.v2.ReportResultKt.ReportingSetResultKt.reportingWindow
import org.wfanet.measurement.internal.reporting.v2.ReportResultKt.ReportingSetResultKt.reportingWindowEntry
import org.wfanet.measurement.internal.reporting.v2.ReportResultKt.ReportingSetResultKt.reportingWindowResult
import org.wfanet.measurement.internal.reporting.v2.ReportResultKt.reportingSetResult
import org.wfanet.measurement.internal.reporting.v2.ReportResultKt.reportingSetResultEntry
    ...
    assertThat(response)
      ...
      .isEqualTo(
        request.reportResult.copy {
          reportingSetResults[0] =
            reportingSetResults[0].copy {
              value =
                value.copy {
                  metricFrequencySpecFingerprint = 5458822473151716274
                  groupingDimensionFingerprint = 7465474029892374121
                  filterFingerprint = 7674920191665727892
                }
            }
          reportingSetResults[1] =
            reportingSetResults[1].copy {
              value =
                value.copy {
                  metricFrequencySpecFingerprint = 5458822473151716274
                  groupingDimensionFingerprint = 9902857286118237123UL.toLong()
                  filterFingerprint = 7674920191665727892
                }
            }
          reportingSetResults[2] =
            reportingSetResults[2].copy {
              value =
                value.copy {
                  metricFrequencySpecFingerprint = 11987848417806868115UL.toLong()
                  groupingDimensionFingerprint = 7465474029892374121
                  filterFingerprint = 4920607432652011739
                }
            }
        }
      )
      ...
      .isEqualTo(
        errorInfo {
          ...
          metadata[Errors.Metadata.FIELD_NAME.key] =
            "report_result.reporting_set_results[1].key.event_filters"
        }
      )
  }
  ...
  companion object {
    private val UNORDERED_FIELDS =
      listOf(
        ...
        ReportResult.ReportingSetResult.getDescriptor()
          .findFieldByNumber(ReportResult.ReportingSetResult.REPORTING_WINDOW_RESULTS_FIELD_NUMBER),
      )
    ...
    val CREATE_REPORT_RESULT_REQUEST = createReportResultRequest {
      reportResult = reportResult {
        ...
        reportingSetResults += reportingSetResultEntry {
          key = reportingSetResultKey {
