...
fun InternalMetricMetadata.toMetricMetadata(): MetricMetadata {
  ...
  return ResultGroupKt.metricMetadata {
    reportingUnitSummary = ResultGroupKt.MetricMetadataKt.reportingUnitSummary {
      for (internalReportingUnitComponentSummary in source.reportingUnitSummary.reportingUnitComponentSummaryList) {
        reportingUnitComponentSummary += ResultGroupKt.MetricMetadataKt.reportingUnitComponentSummary {
          component = DataProviderKey(internalReportingUnitComponentSummary.cmmsDataProviderId).toName()
          displayName = internalReportingUnitComponentSummary.cmmsDataProviderDisplayName
          for (internalEventGroupSummary in internalReportingUnitComponentSummary.eventGroupSummariesList) {
            eventGroupSummaries += ResultGroupKt.MetricMetadataKt.ReportingUnitComponentSummaryKt.eventGroupSummary {
              eventGroup = MeasurementConsumerEventGroupKey(internalEventGroupSummary.cmmsMeasurementConsumerId, internalEventGroupSummary.cmmsEventGroupId).toName()
            }
          }
        }
      }
  ...
  return ResultGroupKt.metricSet {
      ...
      components +=  ResultGroupKt.MetricSetKt.componentMetricSetMapEntry {
        ...
        value = ResultGroupKt.MetricSetKt.componentMetricSet {
          if (internalDataProviderComponentMetricSetMapEntry.value.hasNonCumulative()) {
            nonCumulative = internalDataProviderComponentMetricSetMapEntry.value.nonCumulative.toBasicMetricSet()
          }
          if (internalDataProviderComponentMetricSetMapEntry.value.hasCumulative()) {
            cumulative = internalDataProviderComponentMetricSetMapEntry.value.cumulative.toBasicMetricSet()
          }
    ...
    for (internalDataProviderComponentIntersectionMetricSet in source.componentIntersectionsList) {
      componentIntersections += ResultGroupKt.MetricSetKt.componentIntersectionMetricSet {
        for (cmmsDataProviderId in internalDataProviderComponentIntersectionMetricSet.cmmsDataProviderIdsList) {
        ...
        if (internalDataProviderComponentIntersectionMetricSet.hasNonCumulative()) {
          nonCumulative = internalDataProviderComponentIntersectionMetricSet.nonCumulative.toBasicMetricSet()
        }
        if (internalDataProviderComponentIntersectionMetricSet.hasCumulative()) {
          cumulative = internalDataProviderComponentIntersectionMetricSet.cumulative.toBasicMetricSet()
        }
      }
    }
  }
