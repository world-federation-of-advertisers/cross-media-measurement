...
class CreateMeasurement(private val measurement: Measurement) :
  ...
  override suspend fun TransactionScope.runTransaction(): Measurement {
    ...
    insertMeasurement(
      ...
      measurement.externalProtocolConfigId,
    )
  ...
  private suspend fun TransactionScope.insertMeasurement(
    ...
    externalProtocolConfigId: String
  ) {
    ...
    val protocolConfigId =
      ProtocolConfigIds.getInternalId(externalProtocolConfigId)
        ?: throw KingdomInternalException(KingdomInternalException.Code.PROTOCOL_CONFIG_NOT_FOUND) {
          "ProtocolConfig with external ID $externalProtocolConfigId not found."
        }
