...
class SingleRequisitionReader : BaseSpannerReader<SingleRequisitionReader.Result>() {
  data class Result(
  ...
  fun fillStatementBuilder(fill: Statement.Builder.() -> Unit): SingleRequisitionReader {
    builder.fill()
    return this
  }
