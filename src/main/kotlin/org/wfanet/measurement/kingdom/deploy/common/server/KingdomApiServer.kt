...
class KingdomApiServerFlags {
  ...
  @CommandLine.Option(
    names = ["--internal-api-authority"],
    description =
      ["The authority used with TLS and HTTP virtual hosting of the Kingdom database APIs."],
    required = true
  )
  lateinit var internalApiAuthority: String
    private set
...
fun runKingdomApiServer(
  ...
  val channel: Channel =
    buildMutualTlsChannel(
        ...
        clientCerts,
        kingdomApiServerFlags.internalApiAuthority
      )
