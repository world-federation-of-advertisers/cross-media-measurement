...
import org.wfanet.measurement.kingdom.deploy.gcloud.spanner.readers.DataProviderReaderLegacy
...
class CreateCampaign(
  ...
  private suspend fun TransactionScope.readDataProviderId(): InternalId {
    val readResult = DataProviderReaderLegacy().readExternalId(transactionContext, externalDataProviderId)
