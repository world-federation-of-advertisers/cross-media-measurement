...
class FrequencyVectorBuilder(
  ...
  /**
   * Add all vids in the [other] Builder to the [FrequencyVector]. If any vid in the [other] Builder
   * is not contained by the VidSamplingInterval of this Builder it is ignored.
   */
