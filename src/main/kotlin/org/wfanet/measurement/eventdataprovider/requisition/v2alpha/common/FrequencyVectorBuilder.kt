...
class FrequencyVectorBuilder(
   ...
   *
   * Each byte is treated as an unsigned value (0-255) representing the frequency for that VID index.
   * This constructor is more memory-efficient than first converting to IntArray as it avoids
