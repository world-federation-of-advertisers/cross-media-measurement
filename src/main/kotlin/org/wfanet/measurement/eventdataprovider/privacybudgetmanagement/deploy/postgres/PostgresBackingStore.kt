 ...
 *
 * @param getConnection is a function that creates a postgres JDBC connection that will be owned by
 * the backing store and should not be used outside this backing store.
 */
class PostgresBackingStore(getConnection: () -> Connection) : PrivacyBudgetLedgerBackingStore {
