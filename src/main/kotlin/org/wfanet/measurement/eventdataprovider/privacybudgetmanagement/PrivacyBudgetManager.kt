...
class PrivacyBudgetManager(
  ...
  /**
   * Checks if charging all the PrivacyBucketGroups identified by the given measurementSpec and
   * requisitionSpec in ACDP composition would not exceed privacy budget.
   *
  ...
  /**
   * Checks if charging all the PrivacyBucketGroups identified by the given measurementSpec and
   * requisitionSpec would not exceed privacy budget, and charge the DpCharge.
   *
  ...
  /**
   * Checks if charging all the PrivacyBucketGroups identified by the given measurementSpec and
   * requisitionSpec would not exceed privacy budget, and charge the AcdpCharge.
   *
