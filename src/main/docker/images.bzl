...
IMAGES_TO_SIGN = [
    struct(
        ...
        image = "//src/main/kotlin/org/wfanet/measurement/duchy/deploy/gcloud/job/mill/shareshuffle:gcs_honest_majority_share_shuffle_mill_job_image",
        repository = _PREFIX + "/duchy/test_signed_image",
    ),
]
...
#WIP: added IMAGES_TO_SIGN just for testin
ALL_IMAGES = COMMON_IMAGES + LOCAL_IMAGES + GKE_IMAGES + REPORTING_V2_COMMON_IMAGES + REPORTING_V2_LOCAL_IMAGES + REPORTING_V2_GKE_IMAGES + EKS_IMAGES + SECURE_COMPUTATION_COMMON_IMAGES + SECURE_COMPUTATION_GKE_IMAGES + IMAGES_TO_SIGN
