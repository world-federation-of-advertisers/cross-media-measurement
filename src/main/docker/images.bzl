...
#ALL_SECURE_COMPUTATION_GKE_IMAGES = []
...
ALL_GKE_IMAGES = COMMON_IMAGES + GKE_IMAGES + ALL_SECURE_COMPUTATION_GKE_IMAGES
#ALL_GKE_IMAGES = ALL_SECURE_COMPUTATION_GKE_IMAGES
